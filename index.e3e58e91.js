 ...
 * limitations under the License.
 */
var i,s;r.setAttribute("src",e),r.onload=t,r.onerror=e=>{const t=Us("internal-error");t.customData=e,n(t)},r.type="text/javascript",r.charset="UTF-8",(null!==(s=null===(i=document.getElementsByTagName("head"))||void 0===i?void 0:i[0])&&void 0!==s?s:document).appendChild(r)}))}function ka(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
ka("rcb"),new Js(3e4,6e4);async function Ra(e,t,n){var r;const i=await n.verify();try{let s;if(js("string"==typeof i,e,"argument-error"),js("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){js("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Na{verifyPhoneNumber(e,t){return Ra(this.auth,e,xi(t))}static credential(e,t){return Ko._fromVerification(e,t)}static credentialFromResult(e){const t=e;return Na.credentialFromTaggedObject(t)}static credentialFromError(e){return Na.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:n}=e;return t&&n?Ko._fromTokenResponse(t,n):null}constructor(e){this.providerId=Na.PROVIDER_ID,this.auth=Mo(e)}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Pa(e,t){return t?zs(t):(js(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Na.PROVIDER_ID="phone",Na.PHONE_SIGN_IN_METHOD="phone";class Oa extends qo{_getIdTokenResponse(e){return zo(e,this._buildIdpRequest())}_linkToIdToken(e,t){return zo(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return zo(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Aa(e){return ca(e.auth,new Oa(e),e.bypassAuthState)}function xa(e){const{auth:t,user:n}=e;return js(n,t,"internal-error"),aa(n,new Oa(e),e.bypassAuthState)}async function La(e){const{auth:t,user:n}=e;return js(n,t,"internal-error"),oa(n,new Oa(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Da{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:r,tenantId:i,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:i||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Aa;case"linkViaPopup":case"linkViaRedirect":return La;case"reauthViaPopup":case"reauthViaRedirect":return xa;default:Ms(this.auth,"internal-error")}}resolve(e){Ws(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Ws(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,r,i=!1){this.auth=e,this.resolver=n,this.user=r,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Fa=new Map;class Ba extends Da{async execute(){let e=Fa.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Wa(t),r=qa(e);if(!await r._isAvailable())return!1;const i="true"===await r._get(n);return await r._remove(n),i}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Fa.set(this.auth._key(),e)}return this.bypassAuthState||Fa.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}}function ja(e,t){Fa.set(e._key(),t)}function qa(e){return zs(e._redirectPersistence)}function Wa(e){return wo("pendingRedirect",e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qa=new Js(3e4,6e4);function Xa(){const e=_a().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Za=null;function ec(e){return Za=Za||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){Xa(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Xa(),n(Us(e,"network-request-failed"))},timeout:Qa.get()})}if(null===(i=null===(r=_a().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=_a().gapi)||void 0===s?void 0:s.load)){const t=ka("iframefcb");return _a()[t]=()=>{gapi.load?o():n(Us(e,"network-request-failed"))},Sa(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Za=null,e}))}(e),Za}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tc=new Js(5e3,15e3),nc={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},rc=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ic(e){const t=e.config;js(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Ys(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,r={apiKey:t.apiKey,appName:e.name,v:"9.15.0"},i=rc.get(e.config.apiHost);i&&(r.eid=i);const s=e._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${Ei(r).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Ei(a).slice(1)}`}const lc=class{async _openPopup(e,t,n,r){var i;Ws(null===(i=this.eventManagers[e._key()])||void 0===i?void 0:i.manager,"_initialize() not called before _openPopup()");return ac(e,cc(e,t,n,$s(),r),ga())}async _openRedirect(e,t,n,r){var i;return await this._originValidation(e),i=cc(e,t,n,$s(),r),_a().location.href=i,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(Ws(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await ec(e),n=_a().gapi;return js(n,e,"internal-error"),t.open({where:document.body,url:ic(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:nc,dontclear:!0},(t=>new Promise((async(n,r)=>{await t.restyle({setHideOnLeave:!1});const i=Us(e,"network-request-failed"),s=_a().setTimeout((()=>{r(i)}),tc.get());function o(){_a().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{r(i)}))}))))}(e),n=new za(e);return t.register("authEvent",(t=>{js(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var r;const i=null===(r=null==n?void 0:n[0])||void 0===r?void 0:r.webStorageSupport;void 0!==i&&t(!!i),Ms(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Ja(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Ao()||To()||Po()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=fa,this._completeRedirectFn=Ha,this._overrideRedirectResult=ja}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _c=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new gc(t)}}catch(e){}return new mc},yc=_c("localStorage"),vc=_c("sessionStorage"),wc=new zi("@firebase/database"),bc=function(){let e=1;return function(){return e++}}(),Ic=function(e){const t=Oi(e),n=new Si;n.update(t);const r=n.digest();return Hr.encodeByteArray(r)},Ec=function(...e){let t="";for(let n=0;n<e.length;n++){const r=e[n];Array.isArray(r)||r&&"object"==typeof r&&"number"==typeof r.length?t+=Ec.apply(null,r):t+="object"==typeof r?fi(r):r,t+=" "}return t};let Tc=null,Cc=!0;const Sc=function(e,t){jr(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?(wc.logLevel=Fi.VERBOSE,Tc=wc.log.bind(wc),t&&vc.set("logging_enabled",!0)):"function"==typeof e?Tc=e:(Tc=null,vc.remove("logging_enabled"))},kc=function(...e){if(!0===Cc&&(Cc=!1,null===Tc&&!0===vc.get("logging_enabled")&&Sc(!0)),Tc){const t=Ec.apply(null,e);Tc(t)}},Rc=function(e){return function(...t){kc(e,...t)}},Nc=function(...e){const t="FIREBASE INTERNAL ERROR: "+Ec(...e);wc.error(t)},Pc=function(...e){const t=`FIREBASE FATAL ERROR: ${Ec(...e)}`;throw wc.error(t),new Error(t)},Oc=function(...e){const t="FIREBASE WARNING: "+Ec(...e);wc.warn(t)},Ac=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},xc=function(e,t){if(e===t)return 0;if("[MIN_NAME]"===e||"[MAX_NAME]"===t)return-1;if("[MIN_NAME]"===t||"[MAX_NAME]"===e)return 1;{const n=qc(e),r=qc(t);return null!==n?null!==r?n-r==0?e.length-t.length:n-r:-1:null!==r?1:e<t?-1:1}},Lc=function(e,t){return e===t?0:e<t?-1:1},Dc=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+fi(t))},Mc=function(e){if("object"!=typeof e||null===e)return fi(e);const t=[];for(const n in e)t.push(n);t.sort();let n="{";for(let r=0;r<t.length;r++)0!==r&&(n+=","),n+=fi(t[r]),n+=":",n+=Mc(e[t[r]]);return n+="}",n},Uc=function(e,t){const n=e.length;if(n<=t)return[e];const r=[];for(let i=0;i<n;i+=t)i+t>n?r.push(e.substring(i,n)):r.push(e.substring(i,i+t));return r};function Fc(e,t){for(const n in e)e.hasOwnProperty(n)&&t(n,e[n])}const Bc=function(e){jr(!Ac(e),"Invalid JSON number");const t=1023;let n,r,i,s,o;0===e?(r=0,i=0,n=1/e==-1/0?1:0):(n=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(s=Math.min(Math.floor(Math.log(e)/Math.LN2),t),r=s+t,i=Math.round(e*Math.pow(2,52-s)-Math.pow(2,52))):(r=0,i=Math.round(e/Math.pow(2,-1074))));const a=[];for(o=52;o;o-=1)a.push(i%2?1:0),i=Math.floor(i/2);for(o=11;o;o-=1)a.push(r%2?1:0),r=Math.floor(r/2);a.push(n?1:0),a.reverse();const c=a.join("");let l="";for(o=0;o<64;o+=8){let e=parseInt(c.substr(o,8),2).toString(16);1===e.length&&(e="0"+e),l+=e}return l.toLowerCase()};const jc=new RegExp("^-?(0*)\\d{1,10}$"),qc=function(e){if(jc.test(e)){const t=Number(e);if(t>=-2147483648&&t<=2147483647)return t}return null},Wc=function(e){try{e()}catch(e){setTimeout((()=>{const t=e.stack||"";throw Oc("Exception was thrown by user callback.",t),e}),Math.floor(0))}},Hc=function(e,t){const n=setTimeout(e,t);return"number"==typeof n&&"undefined"!=typeof Deno&&Deno.unrefTimer?Deno.unrefTimer(n):"object"==typeof n&&n.unref&&n.unref(),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gc{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&yc.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,r,i=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=r,this.nodeAdmin=i,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=yc.get("host:"+e)||this._host}}function Jc(e,t,n){let r;if(jr("string"==typeof t,"typeof type must == string"),jr("object"==typeof n,"typeof params must == object"),"websocket"===t)r=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);r=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const i=[];return Fc(n,((e,t)=>{i.push(e+"="+t)})),r+i.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sl extends cl{static getInstance(){return new Sl}getInitialEvent(e){return jr("visible"===e,"Unknown event type: "+e),[this.visible_]}constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Rl{static Wrap(e,t){return new Rl(e,t)}constructor(e,t){this.name=e,this.node=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new Rl("[MIN_NAME]",e),r=new Rl("[MIN_NAME]",t);return 0!==this.compare(n,r)}minPost(){return Rl.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pl;class Ol extends Nl{static get __EMPTY_NODE(){return Pl}static set __EMPTY_NODE(e){Pl=e}compare(e,t){return xc(e.name,t.name)}isDefinedOn(e){throw qr("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Rl.MIN}maxPost(){return new Rl("[MAX_NAME]",Pl)}makePost(e,t){return jr("string"==typeof e,"KeyIndex indexValue must always be a string."),new Rl(e,Pl)}toString(){return".key"}}const Al=new Ol;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ml(e,t){return xc(e.name,t.name)}function Ul(e,t){return xc(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fl;Dl.EMPTY_NODE=new class{copy(e,t,n,r,i){return this}insert(e,t,n){return new Ll(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const Bl=function(e){return"number"==typeof e?"number:"+Bc(e):"string:"+e},jl=function(e){if(e.isLeafNode()){const t=e.val();jr("string"==typeof t||"number"==typeof t||"object"==typeof t&&_i(t,".sv"),"Priority must be a string or number.")}else jr(e===Fl||e.isEmpty(),"priority of unexpected type.");jr(e===Fl||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let ql,Wl,Hl;class zl{static set __childrenNodeConstructor(e){ql=e}static get __childrenNodeConstructor(){return ql}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new zl(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:zl.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return vl(e)?this:".priority"===dl(e)?this.priorityNode_:zl.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:zl.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=dl(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(jr(".priority"!==n||1===fl(e),".priority must be the last token in a path"),this.updateImmediateChild(n,zl.__childrenNodeConstructor.EMPTY_NODE.updateChild(pl(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Bl(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?Bc(this.value_):this.value_,this.lazyHash_=Ic(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===zl.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof zl.__childrenNodeConstructor?-1:(jr(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,r=zl.VALUE_TYPE_ORDER.indexOf(t),i=zl.VALUE_TYPE_ORDER.indexOf(n);return jr(r>=0,"Unknown leaf type: "+t),jr(i>=0,"Unknown leaf type: "+n),r===i?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:i-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}constructor(e,t=zl.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,jr(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),jl(this.priorityNode_)}}zl.VALUE_TYPE_ORDER=["object","boolean","number","string"];const $l=new class extends Nl{compare(e,t){const n=e.node.getPriority(),r=t.node.getPriority(),i=n.compareTo(r);return 0===i?xc(e.name,t.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Rl.MIN}maxPost(){return new Rl("[MAX_NAME]",new zl("[PRIORITY-POST]",Hl))}makePost(e,t){const n=Wl(e);return new Rl(t,new zl("[PRIORITY-POST]",n))}toString(){return".priority"}},Vl=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Jl;const Yl={};class Ql{static get Default(){return jr(Yl&&$l,"ChildrenNode.ts has not been loaded"),Jl=Jl||new Ql({".priority":Yl},{".priority":$l}),Jl}get(e){const t=yi(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Dl?t:null}hasIndex(e){return _i(this.indexSet_,e.toString())}addIndex(e,t){jr(e!==Al,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const i=t.getIterator(Rl.Wrap);let s,o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=i.getNext();s=r?Gl(n,e.getCompare()):Yl;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const l=Object.assign({},this.indexes_);return l[a]=s,new Ql(l,c)}addToIndexes(e,t){const n=wi(this.indexes_,((n,r)=>{const i=yi(this.indexSet_,r);if(jr(i,"Missing index implementation for "+r),n===Yl){if(i.isDefinedOn(e.node)){const n=[],r=t.getIterator(Rl.Wrap);let s=r.getNext();for(;s;)s.name!==e.name&&n.push(s),s=r.getNext();return n.push(e),Gl(n,i.getCompare())}return Yl}{const r=t.get(e.name);let i=n;return r&&(i=i.remove(new Rl(e.name,r))),i.insert(e,e.node)}}));return new Ql(n,this.indexSet_)}removeFromIndexes(e,t){const n=wi(this.indexes_,(n=>{if(n===Yl)return n;{const r=t.get(e.name);return r?n.remove(new Rl(e.name,r)):n}}));return new Ql(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xl;class Zl{static get EMPTY_NODE(){return Xl||(Xl=new Zl(new Dl(Ul),null,Ql.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Xl}updatePriority(e){return this.children_.isEmpty()?this:new Zl(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?Xl:t}}getChild(e){const t=dl(e);return null===t?this:this.getImmediateChild(t).getChild(pl(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(jr(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new Rl(e,t);let r,i;t.isEmpty()?(r=this.children_.remove(e),i=this.indexMap_.removeFromIndexes(n,this.children_)):(r=this.children_.insert(e,t),i=this.indexMap_.addToIndexes(n,this.children_));const s=r.isEmpty()?Xl:this.priorityNode_;return new Zl(r,s,i)}}updateChild(e,t){const n=dl(e);if(null===n)return t;{jr(".priority"!==dl(e)||1===fl(e),".priority must be the last token in a path");const r=this.getImmediateChild(n).updateChild(pl(e),t);return this.updateImmediateChild(n,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,r=0,i=!0;if(this.forEachChild($l,((s,o)=>{t[s]=o.val(e),n++,i&&Zl.INTEGER_REGEXP_.test(s)?r=Math.max(r,Number(s)):i=!1})),!e&&i&&r<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+Bl(this.getPriority().val())+":"),this.forEachChild($l,((t,n)=>{const r=n.hash();""!==r&&(e+=":"+t+":"+r)})),this.lazyHash_=""===e?"":Ic(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const r=this.resolveIndex_(n);if(r){const n=r.getPredecessorKey(new Rl(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new Rl(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new Rl(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,Rl.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)<0;)n.getNext(),r=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,Rl.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)>0;)n.getNext(),r=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===eu?-1:0}withIndex(e){if(e===Al||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new Zl(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Al||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator($l),n=t.getIterator($l);let r=e.getNext(),i=n.getNext();for(;r&&i;){if(r.name!==i.name||!r.node.equals(i.node))return!1;r=e.getNext(),i=n.getNext()}return null===r&&null===i}return!1}return!1}}resolveIndex_(e){return e===Al?null:this.indexMap_.get(e.toString())}constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&jl(this.priorityNode_),this.children_.isEmpty()&&jr(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}}Zl.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const eu=new class extends Zl{compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return Zl.EMPTY_NODE}isEmpty(){return!1}constructor(){super(new Dl(Ul),Zl.EMPTY_NODE,Ql.Default)}};Object.defineProperties(Rl,{MIN:{value:new Rl("[MIN_NAME]",Zl.EMPTY_NODE)},MAX:{value:new Rl("[MAX_NAME]",eu)}}),Ol.__EMPTY_NODE=Zl.EMPTY_NODE,zl.__childrenNodeConstructor=Zl,Fl=eu,function(e){Hl=e}(eu);function tu(e,t=null){if(null===e)return Zl.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),jr(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new zl(e,tu(t))}if(e instanceof Array){let n=Zl.EMPTY_NODE;return Fc(e,((t,r)=>{if(_i(e,t)&&"."!==t.substring(0,1)){const e=tu(r);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(tu(t))}{const n=[];let r=!1;if(Fc(e,((e,t)=>{if("."!==e.substring(0,1)){const i=tu(t);i.isEmpty()||(r=r||!i.getPriority().isEmpty(),n.push(new Rl(e,i)))}})),0===n.length)return Zl.EMPTY_NODE;const i=Gl(n,Ml,(e=>e.name),Ul);if(r){const e=Gl(n,$l.getCompare());return new Zl(i,tu(t),new Ql({".priority":e},{".priority":$l}))}return new Zl(i,tu(t),Ql.Default)}}!function(e){Wl=e}(tu);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class nu extends Nl{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?xc(e.name,t.name):i}makePost(e,t){const n=tu(e),r=Zl.EMPTY_NODE.updateChild(this.indexPath_,n);return new Rl(t,r)}maxPost(){const e=Zl.EMPTY_NODE.updateChild(this.indexPath_,eu);return new Rl("[MAX_NAME]",e)}toString(){return ml(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,jr(!vl(e)&&".priority"!==dl(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ru=new class extends Nl{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?xc(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Rl.MIN}maxPost(){return Rl.MAX}makePost(e,t){const n=tu(e);return new Rl(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class cu{hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return jr(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return jr(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return jr(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return jr(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return jr(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===$l}copy(){const e=new cu;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=$l}}function lu(e){const t={};if(e.isDefault())return t;let n;if(e.index_===$l?n="$priority":e.index_===ru?n="$value":e.index_===Al?n="$key":(jr(e.index_ instanceof nu,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=fi(n),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=fi(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+fi(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=fi(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+fi(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function uu(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==$l&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hu extends al{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(jr(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,r){const i=e._path.toString();this.log_("Listen called for "+i+" "+e._queryIdentifier);const s=hu.getListenId_(e,n),o={};this.listens_[s]=o;const a=lu(e._queryParams);this.restRequest_(i+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(i,a,!1,n),yi(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",r(t,null)}}))}unlisten(e,t){const n=hu.getListenId_(e,t);delete this.listens_[n]}get(e){const t=lu(e._queryParams),n=e._path.toString(),r=new ai;return this.restRequest_(n+".json",t,((e,t)=>{let i=t;404===e&&(i=null,e=null),null===e?(this.onDataUpdate_(n,i,!1,null),r.resolve(i)):r.reject(new Error(i))})),r.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([r,i])=>{r&&r.accessToken&&(t.auth=r.accessToken),i&&i.token&&(t.ac=i.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ei(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=di(o.responseText)}catch(e){Oc("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Oc("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}constructor(e,t,n,r){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=r,this.log_=Rc("p:rest:"),this.listens_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class du{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=Zl.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fu(){return{value:null,children:new Map}}function pu(e,t,n){if(vl(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const r=dl(t);e.children.has(r)||e.children.set(r,fu());pu(e.children.get(r),t=pl(t),n)}}function gu(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{gu(r,new ul(t.toString()+"/"+e),n)}))}class mu{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Fc(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _u{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Fc(e,((e,r)=>{r>0&&_i(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),Hc(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new mu(e);const n=1e4+2e4*Math.random();Hc(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var yu,vu;function wu(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(vu=yu||(yu={}))[vu.OVERWRITE=0]="OVERWRITE",vu[vu.MERGE=1]="MERGE",vu[vu.ACK_USER_WRITE=2]="ACK_USER_WRITE",vu[vu.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class bu{operationForChild(e){if(vl(this.path)){if(null!=this.affectedTree.value)return jr(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ul(e));return new bu(hl(),t,this.revert)}}return jr(dl(this.path)===e,"operationForChild called for unrelated child."),new bu(pl(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=yu.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Iu{operationForChild(e){return vl(this.path)?new Iu(this.source,hl(),this.snap.getImmediateChild(e)):new Iu(this.source,pl(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=yu.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu{operationForChild(e){if(vl(this.path)){const t=this.children.subtree(new ul(e));return t.isEmpty()?null:t.value?new Iu(this.source,hl(),t.value):new Eu(this.source,hl(),t)}return jr(dl(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Eu(this.source,pl(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=yu.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cu(e,t,n,r,i,s){const o=r.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw qr("Should only compare child_ events.");const r=new Rl(t.childName,t.snapshotNode),i=new Rl(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);i.forEach((i=>{i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function Su(e,t){return{eventCache:e,serverCache:t}}function ku(e,t,n,r){return Su(new Tu(t,n,r),e.serverCache)}function Ru(e,t,n,r){return Su(e.eventCache,new Tu(t,n,r))}function Nu(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Pu(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ou;class Au{static fromObject(e){let t=new Au(null);return Fc(e,((e,n)=>{t=t.set(new ul(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:hl(),value:this.value};if(vl(e))return null;{const n=dl(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(pl(e),t);if(null!=i){return{path:yl(new ul(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(vl(e))return this;{const t=dl(e),n=this.children.get(t);return null!==n?n.subtree(pl(e)):new Au(null)}}set(e,t){if(vl(e))return new Au(t,this.children);{const n=dl(e),r=(this.children.get(n)||new Au(null)).set(pl(e),t),i=this.children.insert(n,r);return new Au(this.value,i)}}remove(e){if(vl(e))return this.children.isEmpty()?new Au(null):new Au(null,this.children);{const t=dl(e),n=this.children.get(t);if(n){const r=n.remove(pl(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new Au(null):new Au(this.value,i)}return this}}get(e){if(vl(e))return this.value;{const t=dl(e),n=this.children.get(t);return n?n.get(pl(e)):null}}setTree(e,t){if(vl(e))return t;{const n=dl(e),r=(this.children.get(n)||new Au(null)).setTree(pl(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new Au(this.value,i)}}fold(e){return this.fold_(hl(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(yl(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,hl(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(vl(e))return null;{const r=dl(e),i=this.children.get(r);return i?i.findOnPath_(pl(e),yl(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,hl(),t)}foreachOnPath_(e,t,n){if(vl(e))return this;{this.value&&n(t,this.value);const r=dl(e),i=this.children.get(r);return i?i.foreachOnPath_(pl(e),yl(t,r),n):new Au(null)}}foreach(e){this.foreach_(hl(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(yl(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(Ou||(Ou=new Dl(Lc)),Ou))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xu{static empty(){return new xu(new Au(null))}constructor(e){this.writeTree_=e}}function Lu(e,t,n){if(vl(t))return new xu(new Au(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=wl(i,t);return s=s.updateChild(o,n),new xu(e.writeTree_.set(i,s))}{const r=new Au(n),i=e.writeTree_.setTree(t,r);return new xu(i)}}}function Du(e,t,n){let r=e;return Fc(n,((e,n)=>{r=Lu(r,yl(t,e),n)})),r}function Mu(e,t){if(vl(t))return xu.empty();{const n=e.writeTree_.setTree(t,new Au(null));return new xu(n)}}function Uu(e,t){return null!=Fu(e,t)}function Fu(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(wl(n.path,t)):null}function Bu(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild($l,((e,n)=>{t.push(new Rl(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Rl(e,n.value))})),t}function ju(e,t){if(vl(t))return e;{const n=Fu(e,t);return new xu(null!=n?new Au(n):e.writeTree_.subtree(t))}}function qu(e){return e.writeTree_.isEmpty()}function Wu(e,t){return Hu(hl(),e.writeTree_,t)}function Hu(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?(jr(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=Hu(yl(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(yl(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zu(e,t){return rh(t,e)}function $u(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));jr(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let i=r.visible,s=!1,o=e.allWrites.length-1;for(;i&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&Vu(t,r.path)?i=!1:Il(r.path,t.path)&&(s=!0)),o--}if(i){if(s)return function(e){e.visibleWrites=Gu(e.allWrites,Ku,hl()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=Mu(e.visibleWrites,r.path);else{Fc(r.children,(t=>{e.visibleWrites=Mu(e.visibleWrites,yl(r.path,t))}))}return!0}return!1}function Vu(e,t){if(e.snap)return Il(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Il(yl(e.path,n),t))return!0;return!1}function Ku(e){return e.visible}function Gu(e,t,n){let r=xu.empty();for(let i=0;i<e.length;++i){const s=e[i];if(t(s)){const e=s.path;let t;if(s.snap)Il(n,e)?(t=wl(n,e),r=Lu(r,t,s.snap)):Il(e,n)&&(t=wl(e,n),r=Lu(r,hl(),s.snap.getChild(t)));else{if(!s.children)throw qr("WriteRecord should have .snap or .children");if(Il(n,e))t=wl(n,e),r=Du(r,t,s.children);else if(Il(e,n))if(t=wl(e,n),vl(t))r=Du(r,hl(),s.children);else{const e=yi(s.children,dl(t));if(e){const n=e.getChild(pl(t));r=Lu(r,hl(),n)}}}}}return r}function Ju(e,t,n,r,i){if(r||i){const s=ju(e.visibleWrites,t);if(!i&&qu(s))return n;if(i||null!=n||Uu(s,hl())){const s=function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(Il(e.path,t)||Il(t,e.path))};return Wu(Gu(e.allWrites,s,t),n||Zl.EMPTY_NODE)}return null}{const r=Fu(e.visibleWrites,t);if(null!=r)return r;{const r=ju(e.visibleWrites,t);if(qu(r))return n;if(null!=n||Uu(r,hl())){return Wu(r,n||Zl.EMPTY_NODE)}return null}}}function Yu(e,t,n,r){return Ju(e.writeTree,e.treePath,t,n,r)}function Qu(e,t){return function(e,t,n){let r=Zl.EMPTY_NODE;const i=Fu(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild($l,((e,t)=>{r=r.updateImmediateChild(e,t)})),r;if(n){const i=ju(e.visibleWrites,t);return n.forEachChild($l,((e,t)=>{const n=Wu(ju(i,new ul(e)),t);r=r.updateImmediateChild(e,n)})),Bu(i).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}return Bu(ju(e.visibleWrites,t)).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function Xu(e,t,n,r){return function(e,t,n,r,i){jr(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=yl(t,n);if(Uu(e.visibleWrites,s))return null;{const t=ju(e.visibleWrites,s);return qu(t)?i.getChild(n):Wu(t,i.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function Zu(e,t){return function(e,t){return Fu(e.visibleWrites,t)}(e.writeTree,yl(e.treePath,t))}function eh(e,t,n,r,i,s){return function(e,t,n,r,i,s,o){let a;const c=ju(e.visibleWrites,t),l=Fu(c,hl());if(null!=l)a=l;else{if(null==n)return[];a=Wu(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let c=n.getNext();for(;c&&e.length<i;)0!==t(c,r)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,r,i,s)}function th(e,t,n){return function(e,t,n,r){const i=yl(t,n),s=Fu(e.visibleWrites,i);if(null!=s)return s;if(r.isCompleteForChild(n))return Wu(ju(e.visibleWrites,i),r.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function nh(e,t){return rh(yl(e.treePath,t),e.writeTree)}function rh(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ih{trackChildChange(e){const t=e.type,n=e.childName;jr("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),jr(".priority"!==n,"Only non-priority child changes can be tracked.");const r=this.changeMap.get(n);if(r){const i=r.type;if("child_added"===t&&"child_removed"===i)this.changeMap.set(n,au(n,e.snapshotNode,r.snapshotNode));else if("child_removed"===t&&"child_added"===i)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===i)this.changeMap.set(n,ou(n,r.oldSnap));else if("child_changed"===t&&"child_added"===i)this.changeMap.set(n,su(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==i)throw qr("Illegal combination of changes: "+e+" occurred after "+r);this.changeMap.set(n,au(n,e.snapshotNode,r.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sh=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class oh{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Tu(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return th(this.writes_,e,t)}}getChildAfterChild(e,t,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Pu(this.viewCache_),i=eh(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ah(e,t,n,r,i){const s=new ih;let o,a;if(n.type===yu.OVERWRITE){const c=n;c.source.fromUser?o=uh(e,t,c.path,c.snap,r,i,s):(jr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!vl(c.path),o=lh(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===yu.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=yl(n,r);hh(t,dl(l))&&(a=uh(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=yl(n,r);hh(t,dl(l))||(a=uh(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(jr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=fh(e,t,c.path,c.children,r,i,a,s))}else if(n.type===yu.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=Zu(r,n))return t;{const a=new oh(r,t,i),c=t.eventCache.getNode();let l;if(vl(n)||".priority"===dl(n)){let n;if(t.serverCache.isFullyInitialized())n=Yu(r,Pu(t));else{const e=t.serverCache.getNode();jr(e instanceof Zl,"serverChildren would be complete if leaf node"),n=Qu(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=dl(n);let u=th(r,i,t.serverCache);null==u&&t.serverCache.isCompleteForChild(i)&&(u=c.getImmediateChild(i)),l=null!=u?e.filter.updateChild(c,i,u,pl(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,Zl.EMPTY_NODE,pl(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Yu(r,Pu(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Zu(r,hl()),ku(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,r,i,s):function(e,t,n,r,i,s,o){if(null!=Zu(i,n))return t;const a=t.serverCache.isFiltered(),c=t.serverCache;if(null!=r.value){if(vl(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return lh(e,t,n,c.getNode().getChild(n),i,s,a,o);if(vl(n)){let r=new Au(null);return c.getNode().forEachChild(Al,((e,t)=>{r=r.set(new ul(e),t)})),fh(e,t,n,r,i,s,a,o)}return t}{let l=new Au(null);return r.foreach(((e,t)=>{const r=yl(n,e);c.isCompleteForPath(r)&&(l=l.set(e,c.getNode().getChild(r)))})),fh(e,t,n,l,i,s,a,o)}}(e,t,a.path,a.affectedTree,r,i,s)}else{if(n.type!==yu.LISTEN_COMPLETE)throw qr("Unknown operation type: "+n.type);o=function(e,t,n,r,i){const s=t.serverCache,o=Ru(t,s.getNode(),s.isFullyInitialized()||vl(n),s.isFiltered());return ch(e,o,n,r,sh,i)}(e,t,n.path,r,s)}const c=s.getChanges();return function(e,t,n){const r=t.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=Nu(e);(n.length>0||!e.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(iu(Nu(t)))}}(t,o,c),{viewCache:o,changes:c}}function ch(e,t,n,r,i,s){const o=t.eventCache;if(null!=Zu(r,n))return t;{let a,c;if(vl(n))if(jr(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Pu(t),i=Qu(r,n instanceof Zl?n:Zl.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),i,s)}else{const n=Yu(r,Pu(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const l=dl(n);if(".priority"===l){jr(1===fl(n),"Can't have a priority with additional path components");const i=o.getNode();c=t.serverCache.getNode();const s=Xu(r,n,i,c);a=null!=s?e.filter.updatePriority(i,s):o.getNode()}else{const u=pl(n);let h;if(o.isCompleteForChild(l)){c=t.serverCache.getNode();const e=Xu(r,n,o.getNode(),c);h=null!=e?o.getNode().getImmediateChild(l).updateChild(u,e):o.getNode().getImmediateChild(l)}else h=th(r,l,t.serverCache);a=null!=h?e.filter.updateChild(o.getNode(),l,h,u,i,s):o.getNode()}}return ku(t,a,o.isFullyInitialized()||vl(n),e.filter.filtersNodes())}}function lh(e,t,n,r,i,s,o,a){const c=t.serverCache;let l;const u=o?e.filter:e.filter.getIndexedFilter();if(vl(n))l=u.updateFullNode(c.getNode(),r,null);else if(u.filtersNodes()&&!c.isFiltered()){const e=c.getNode().updateChild(n,r);l=u.updateFullNode(c.getNode(),e,null)}else{const e=dl(n);if(!c.isCompleteForPath(n)&&fl(n)>1)return t;const i=pl(n),s=c.getNode().getImmediateChild(e).updateChild(i,r);l=".priority"===e?u.updatePriority(c.getNode(),s):u.updateChild(c.getNode(),e,s,i,sh,null)}const h=Ru(t,l,c.isFullyInitialized()||vl(n),u.filtersNodes());return ch(e,h,n,i,new oh(i,h,s),a)}function uh(e,t,n,r,i,s,o){const a=t.eventCache;let c,l;const u=new oh(i,t,s);if(vl(n))l=e.filter.updateFullNode(t.eventCache.getNode(),r,o),c=ku(t,l,!0,e.filter.filtersNodes());else{const i=dl(n);if(".priority"===i)l=e.filter.updatePriority(t.eventCache.getNode(),r),c=ku(t,l,a.isFullyInitialized(),a.isFiltered());else{const s=pl(n),l=a.getNode().getImmediateChild(i);let h;if(vl(s))h=r;else{const e=u.getCompleteChild(i);h=null!=e?".priority"===gl(s)&&e.getChild(_l(s)).isEmpty()?e:e.updateChild(s,r):Zl.EMPTY_NODE}if(l.equals(h))c=t;else{c=ku(t,e.filter.updateChild(a.getNode(),i,h,s,u,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return c}function hh(e,t){return e.eventCache.isCompleteForChild(t)}function dh(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function fh(e,t,n,r,i,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let c,l=t;c=vl(n)?r:new Au(null).setTree(n,r);const u=t.serverCache.getNode();return c.children.inorderTraversal(((n,r)=>{if(u.hasChild(n)){const c=dh(0,t.serverCache.getNode().getImmediateChild(n),r);l=lh(e,l,new ul(n),c,i,s,o,a)}})),c.children.inorderTraversal(((n,r)=>{const c=!t.serverCache.isCompleteForChild(n)&&null===r.value;if(!u.hasChild(n)&&!c){const c=dh(0,t.serverCache.getNode().getImmediateChild(n),r);l=lh(e,l,new ul(n),c,i,s,o,a)}})),l}function ph(e,t){const n=Pu(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!vl(t)&&!n.getImmediateChild(dl(t)).isEmpty())?n.getChild(t):null}function gh(e,t,n,r){t.type===yu.MERGE&&null!==t.source.queryId&&(jr(Pu(e.viewCache_),"We should always have a full cache before handling merges"),jr(Nu(e.viewCache_),"Missing event cache, even though we have a server cache"));const i=e.viewCache_,s=ah(e.processor_,i,t,n,r);var o,a;return o=e.processor_,a=s.viewCache,jr(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),jr(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),jr(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,mh(e,s.changes,s.viewCache.eventCache.getNode(),null)}function mh(e,t,n,r){const i=r?[r]:e.eventRegistrations_;return function(e,t,n,r){const i=[],s=[];return t.forEach((t=>{var n;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Cu(e,i,"child_removed",t,r,n),Cu(e,i,"child_added",t,r,n),Cu(e,i,"child_moved",s,r,n),Cu(e,i,"child_changed",t,r,n),Cu(e,i,"value",t,r,n),i}(e.eventGenerator_,t,n,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _h,yh;function vh(e,t,n,r){const i=t.source.queryId;if(null!==i){const s=e.views.get(i);return jr(null!=s,"SyncTree gave us an op for an invalid query."),gh(s,t,n,r)}{let i=[];for(const s of e.views.values())i=i.concat(gh(s,t,n,r));return i}}function wh(e,t){let n=null;for(const r of e.views.values())n=n||ph(r,t);return n}class bh{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Au(null),this.pendingWriteTree_={visibleWrites:xu.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Ih(e,t,n,r,i){return function(e,t,n,r,i){jr(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=Lu(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?kh(e,new Iu({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Eh(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if($u(e.pendingWriteTree_,t)){let t=new Au(null);return null!=r.snap?t=t.set(hl(),!0):Fc(r.children,(e=>{t=t.set(new ul(e),!0)})),kh(e,new bu(r.path,t,n))}return[]}function Th(e,t,n){return kh(e,new Iu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Ch(e,t,n,r){const i=Ph(e,r);if(null!=i){const r=Oh(i),s=r.path,o=r.queryId,a=wl(s,t);return Ah(e,s,new Iu(wu(o),a,n))}return[]}function Sh(e,t,n){const r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,((e,n)=>{const r=wh(n,wl(e,t));if(r)return r}));return Ju(r,t,i,n,!0)}function kh(e,t){return Rh(t,e.syncPointTree_,null,zu(e.pendingWriteTree_,hl()))}function Rh(e,t,n,r){if(vl(e.path))return Nh(e,t,n,r);{const i=t.get(hl());null==n&&null!=i&&(n=wh(i,hl()));let s=[];const o=dl(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=nh(r,o);s=s.concat(Rh(a,c,e,t))}return i&&(s=s.concat(vh(i,e,r,n))),s}}function Nh(e,t,n,r){const i=t.get(hl());null==n&&null!=i&&(n=wh(i,hl()));let s=[];return t.children.inorderTraversal(((t,i)=>{const o=n?n.getImmediateChild(t):null,a=nh(r,t),c=e.operationForChild(t);c&&(s=s.concat(Nh(c,i,o,a)))})),i&&(s=s.concat(vh(i,e,r,n))),s}function Ph(e,t){return e.tagToQueryMap.get(t)}function Oh(e){const t=e.indexOf("$");return jr(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new ul(e.substr(0,t))}}function Ah(e,t,n){const r=e.syncPointTree_.get(t);jr(r,"Missing sync point for query tag that we're tracking");return vh(r,n,zu(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class xh{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new xh(t)}node(){return this.node_}constructor(e){this.node_=e}}class Lh{getImmediateChild(e){const t=yl(this.path_,e);return new Lh(this.syncTree_,t)}node(){return Sh(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const Dh=function(e,t,n){return e&&"object"==typeof e?(jr(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Mh(e[".sv"],t,n):"object"==typeof e[".sv"]?Uh(e[".sv"],t):void jr(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Mh=function(e,t,n){if("timestamp"===e)return n.timestamp;jr(!1,"Unexpected server value: "+e)},Uh=function(e,t,n){e.hasOwnProperty("increment")||jr(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&jr(!1,"Unexpected increment value: "+r);const i=t.node();if(jr(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const s=i.getValue();return"number"!=typeof s?r:s+r},Fh=function(e,t,n,r){return jh(t,new Lh(n,e),r)},Bh=function(e,t,n){return jh(e,new xh(t),n)};function jh(e,t,n){const r=e.getPriority().val(),i=Dh(r,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const r=e,s=Dh(r.getValue(),t,n);return s!==r.getValue()||i!==r.getPriority().val()?new zl(s,tu(i)):e}{const r=e;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new zl(i))),r.forEachChild($l,((e,r)=>{const i=jh(r,t.getImmediateChild(e),n);i!==r&&(s=s.updateImmediateChild(e,i))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qh{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Wh(e,t){let n=t instanceof ul?t:new ul(t),r=e,i=dl(n);for(;null!==i;){const e=yi(r.node.children,i)||{children:{},childCount:0};r=new qh(i,r,e),n=pl(n),i=dl(n)}return r}function Hh(e){return e.node.value}function zh(e,t){e.node.value=t,Jh(e)}function $h(e){return e.node.childCount>0}function Vh(e,t){Fc(e.node.children,((n,r)=>{t(new qh(n,e,r))}))}function Kh(e,t,n,r){n&&!r&&t(e),Vh(e,(e=>{Kh(e,t,!0,r)})),n&&r&&t(e)}function Gh(e){return new ul(null===e.parent?e.name:Gh(e.parent)+"/"+e.name)}function Jh(e){null!==e.parent&&function(e,t,n){const r=function(e){return void 0===Hh(e)&&!$h(e)}(n),i=_i(e.node.children,t);r&&i?(delete e.node.children[t],e.node.childCount--,Jh(e)):r||i||(e.node.children[t]=n.node,e.node.childCount++,Jh(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Yh=/[\[\].#$\/\u0000-\u001F\u007F]/,Qh=/[\[\].#$\u0000-\u001F\u007F]/,Xh=function(e){return"string"==typeof e&&0!==e.length&&!Yh.test(e)},Zh=function(e){return"string"==typeof e&&0!==e.length&&!Qh.test(e)},ed=function(e,t,n){const r=n instanceof ul?new El(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Cl(r));if("function"==typeof t)throw new Error(e+"contains a function "+Cl(r)+" with contents = "+t.toString());if(Ac(t))throw new Error(e+"contains "+t.toString()+" "+Cl(r));if("string"==typeof t&&t.length>10485760/3&&Ai(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Cl(r)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,i=!1;if(Fc(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(i=!0,!Xh(t)))throw new Error(e+" contains an invalid key ("+t+") "+Cl(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=r).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=Ai(a),Tl(o),ed(e,s,r),function(e){const t=e.parts_.pop();e.byteLength_-=Ai(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),n&&i)throw new Error(e+' contains ".value" child '+Cl(r)+" in addition to actual children.")}},td=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Xh(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Zh(e)}(n))throw new Error(Pi(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class nd{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function rd(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||bl(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function id(e,t,n){rd(e,n),sd(e,(e=>Il(e,t)||Il(t,e)))}function sd(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(od(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function od(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();Tc&&kc("event: "+n.toString()),Wc(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ad{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new nd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=fu(),this.transactionQueueTree_=new qh,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function cd(e,t,n){if(e.stats_=Zc(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new hu(e.repoInfo_,((t,n,r,i)=>{hd(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>dd(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{fi(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new kl(e.repoInfo_,t,((t,n,r,i)=>{hd(e,t,n,r,i)}),(t=>{dd(e,t)}),(t=>{!function(e,t){Fc(t,((t,n)=>{fd(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return Xc[n]||(Xc[n]=t()),Xc[n]}(e.repoInfo_,(()=>new _u(e.stats_,e.server_))),e.infoData_=new du,e.infoSyncTree_=new bh({startListening:(t,n,r,i)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Th(e.infoSyncTree_,t._path,o),setTimeout((()=>{i("ok")}),0)),s},stopListening:()=>{}}),fd(e,"connected",!1),e.serverSyncTree_=new bh({startListening:(t,n,r,i)=>(e.server_.listen(t,r,n,((n,r)=>{const s=i(n,r);id(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function ld(e){const t=e.infoData_.getNode(new ul(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function ud(e){return(t=(t={timestamp:ld(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function hd(e,t,n,r,i){e.dataUpdateCount++;const s=new ul(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(i)if(r){const t=wi(n,(e=>tu(e)));o=function(e,t,n,r){const i=Ph(e,r);if(i){const r=Oh(i),s=r.path,o=r.queryId,a=wl(s,t),c=Au.fromObject(n);return Ah(e,s,new Eu(wu(o),a,c))}return[]}(e.serverSyncTree_,s,t,i)}else{const t=tu(n);o=Ch(e.serverSyncTree_,s,t,i)}else if(r){const t=wi(n,(e=>tu(e)));o=function(e,t,n){const r=Au.fromObject(n);return kh(e,new Eu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,s,t)}else{const t=tu(n);o=Th(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=vd(e,s)),id(e.eventQueue_,a,o)}function dd(e,t){fd(e,"connected",t),!1===t&&function(e){md(e,"onDisconnectEvents");const t=ud(e),n=fu();gu(e.onDisconnect_,hl(),((r,i)=>{const s=Fh(r,i,e.serverSyncTree_,t);pu(n,r,s)}));let r=[];gu(n,hl(),((t,n)=>{r=r.concat(Th(e.serverSyncTree_,t,n));const i=Td(e,t);vd(e,i)})),e.onDisconnect_=fu(),id(e.eventQueue_,hl(),r)}(e)}function fd(e,t,n){const r=new ul("/.info/"+t),i=tu(n);e.infoData_.updateSnapshot(r,i);const s=Th(e.infoSyncTree_,r,i);id(e.eventQueue_,r,s)}function pd(e){return e.nextWriteId_++}function gd(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function md(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),kc(n,...t)}function _d(e,t,n){return Sh(e.serverSyncTree_,t,n)||Zl.EMPTY_NODE}function yd(e,t=e.transactionQueueTree_){if(t||Ed(e,t),Hh(t)){const n=bd(e,t);jr(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const r=n.map((e=>e.currentWriteId)),i=_d(e,t,r);let s=i;const o=i.hash();for(let e=0;e<n.length;e++){const r=n[e];jr(0===r.status,"tryToSendTransactionQueue_: items in queue should all be run."),r.status=1,r.retryCount++;const i=wl(t,r.path);s=s.updateChild(i,r.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(r=>{md(e,"transaction put response",{path:c.toString(),status:r});let i=[];if("ok"===r){const r=[];for(let t=0;t<n.length;t++)n[t].status=2,i=i.concat(Eh(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&r.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Ed(e,Wh(e.transactionQueueTree_,t)),yd(e,e.transactionQueueTree_),id(e.eventQueue_,t,i);for(let e=0;e<r.length;e++)Wc(r[e])}else{if("datastale"===r)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Oc("transaction at "+c.toString()+" failed: "+r);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=r}vd(e,t)}}),o)}(e,Gh(t),n)}else $h(t)&&Vh(t,(t=>{yd(e,t)}))}function vd(e,t){const n=wd(e,t),r=Gh(n);return function(e,t,n){if(0===t.length)return;const r=[];let i=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=wl(n,c.path);let u,h=!1;if(jr(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)h=!0,u=c.abortReason,i=i.concat(Eh(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)h=!0,u="maxretry",i=i.concat(Eh(e.serverSyncTree_,c.currentWriteId,!0));else{const n=_d(e,c.path,s);c.currentInputSnapshot=n;const r=t[a].update(n.val());if(void 0!==r){ed("transaction failed: Data returned ",r,c.path);let t=tu(r);"object"==typeof r&&null!=r&&_i(r,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=ud(e),l=Bh(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=pd(e),s.splice(s.indexOf(o),1),i=i.concat(Ih(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),i=i.concat(Eh(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",i=i.concat(Eh(e.serverSyncTree_,c.currentWriteId,!0))}id(e.eventQueue_,n,i),i=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?r.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):r.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;Ed(e,e.transactionQueueTree_);for(let e=0;e<r.length;e++)Wc(r[e]);yd(e,e.transactionQueueTree_)}(e,bd(e,n),r),r}function wd(e,t){let n,r=e.transactionQueueTree_;for(n=dl(t);null!==n&&void 0===Hh(r);)r=Wh(r,n),n=dl(t=pl(t));return r}function bd(e,t){const n=[];return Id(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function Id(e,t,n){const r=Hh(t);if(r)for(let e=0;e<r.length;e++)n.push(r[e]);Vh(t,(t=>{Id(e,t,n)}))}function Ed(e,t){const n=Hh(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,zh(t,n.length>0?n:void 0)}Vh(t,(t=>{Ed(e,t)}))}function Td(e,t){const n=Gh(wd(e,t)),r=Wh(e.transactionQueueTree_,t);return function(e,t,n){let r=n?e:e.parent;for(;null!==r;){if(t(r))return!0;r=r.parent}}(r,(t=>{Cd(e,t)})),Cd(e,r),Kh(r,(t=>{Cd(e,t)})),n}function Cd(e,t){const n=Hh(t);if(n){const r=[];let i=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(jr(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(jr(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),i=i.concat(Eh(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&r.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?zh(t,void 0):n.length=s+1,id(e.eventQueue_,Gh(t),i);for(let e=0;e<r.length;e++)Wc(r[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Rd{get key(){return vl(this._path)?null:gl(this._path)}get ref(){return new Nd(this._repo,this._path)}get _queryIdentifier(){const e=uu(this._queryParams),t=Mc(e);return"{}"===t?"default":t}get _queryObject(){return uu(this._queryParams)}isEqual(e){if(!((e=xi(e))instanceof Rd))return!1;const t=this._repo===e._repo,n=bl(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class Nd extends Rd{get parent(){const e=_l(this._path);return null===e?null:new Nd(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new cu,!1)}}!function(e){jr(!_h,"__referenceConstructor has already been defined"),_h=e}(Nd),function(e){jr(!yh,"__referenceConstructor has already been defined"),yh=e}(Nd);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Pd={};let Od=!1;function Ad(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||Pc("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),kc("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=Sd(s,i),l=c.repoInfo;void 0!==Ir&&Ir.env&&(a=Ir.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=Sd(s,i),l=c.repoInfo):o=!c.repoInfo.secure;const u=i&&o?new Vc(Vc.OWNER):new $c(e.name,e.options,t);td("Invalid Firebase Database URL",c),vl(c.path)||Pc("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,r){let i=Pd[t.name];i||(i={},Pd[t.name]=i);let s=i[e.toURLString()];s&&Pc("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new ad(e,Od,n,r),i[e.toURLString()]=s,s}(l,e,u,new zc(e.name,n));return new xd(h,e)}class xd{get _repo(){return this._instanceStarted||(cd(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Nd(this._repo,hl())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Pd[t];n&&n[e.key]===e||Pc(`Database ${t}(${e.repoInfo_}) has already been deleted.`),gd(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Pc("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}kl.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},kl.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){pc="9.15.0",ps(new Li("database",((e,{instanceIdentifier:t})=>Ad(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ws("@firebase/database","0.14.0",e),ws("@firebase/database","0.14.0","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Ld=ys({apiKey:"AIzaSyCDhc_FFOW788b9xS67xRCHGL2Falcnxko",authDomain:"filmoteks-fs61.firebaseapp.com",projectId:"filmoteks-fs61",storageBucket:"filmoteks-fs61.appspot.com",messagingSenderId:"392503967659",appId:"1:392503967659:web:7720f7b1803ed8583b9cee",measurementId:"G-JLEERBJV8V",databaseURL:"https://filmoteks-fs61-default-rtdb.europe-west1.firebasedatabase.app"});(function(e=vs()){const t=gs(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=gs(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(bi(n.getOptions(),null!=t?t:{}))return e;Ms(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:lc,persistence:[Ca,ha,fa]}),r=oi("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>hc)return;const r=null==t?void 0:t.token;dc!==r&&(dc=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){xi(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){xi(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=ii("auth");s&&Fo(n,`http://${s}`)})(Ld),function(e=vs(),t){const n=gs(e,"database").getImmediate({identifier:t}),r=si("database");r&&function(e,t,n,r={}){(e=xi(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&Pc("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&Pc('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new Vc(Vc.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:ci(r.mockUserToken,e.app.options.projectId);s=new Vc(t)}!function(e,t,n,r){e.repoInfo_=new Gc(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),r&&(e.authTokenProvider_=r)}(i,t,n,s)}(n,...r)}(Ld);const Dd=Qn();Dd.modeButton.addEventListener("click",(function(){document.body.classList.contains("moon")?(document.body.classList.remove("moon"),Dd.moon.classList.add("visually-hidden"),Dd.sun.classList.remove("visually-hidden"),localStorage.setItem("mode",!1)):(document.body.classList.add("moon"),localStorage.setItem("mode","moon"),Dd.sun.classList.add("visually-hidden"),Dd.moon.classList.remove("visually-hidden"))})),"moon"===localStorage.getItem("mode")&&(document.body.classList.add("moon"),Dd.sun.classList.add("visually-hidden"),Dd.moon.classList.remove("visually-hidden")),console.log("change6");
//# sourceMappingURL=index.e3e58e91.js.map
