 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();ys({apiKey:"AIzaSyCDhc_FFOW788b9xS67xRCHGL2Falcnxko",authDomain:"filmoteks-fs61.firebaseapp.com",projectId:"filmoteks-fs61",storageBucket:"filmoteks-fs61.appspot.com",messagingSenderId:"392503967659",appId:"1:392503967659:web:7720f7b1803ed8583b9cee",measurementId:"G-JLEERBJV8V",databaseURL:"https://filmoteks-fs61-default-rtdb.europe-west1.firebasedatabase.app"}),function(e=vs()){const t=gs(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=gs(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(bi(n.getOptions(),null!=t?t:{}))return e;Ms(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:lc,persistence:[Ta,ha,fa]}),r=oi("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>hc)return;const r=null==t?void 0:t.token;dc!==r&&(dc=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){Ai(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){Ai(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=ii("auth");s&&Uo(n,`http://${s}`)}(app);const wf=function(e=vs(),t){const n=gs(e,"database").getImmediate({identifier:t}),r=si("database");return r&&function(e,t,n,r={}){(e=Ai(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&Nc("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&Nc('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new Vc(Vc.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:ci(r.mockUserToken,e.app.options.projectId);s=new Vc(t)}!function(e,t,n,r){e.repoInfo_=new Gc(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),r&&(e.authTokenProvider_=r)}(i,t,n,s)}(n,...r),n}(app),bf=[{code:"auth/user-not-found",massage_ru:"Пользователь с такой почтой и паролем не найден",message_ua:"Користувача за цією поштою або паролем не знайдено ",message_en:"User with this password or email don'n found "},{code:"auth/network-request-failed",massage_ru:"Ошибка подключения . Проверьте наличие интернета.",message_ua:"Помилка підключення. Перевірте наявність інтернета",message_en:"Network error!"},{code:"auth/email-already-in-use",massage_ru:"Пользователь с такой почтой уже зарегистрирован!",message_ua:"Користувач з такую поштою вже в системі!",message_en:"This email already in use!"},{code:"auth/login",massage_ru:"Не авторизированные пользователи не могут пользоваться библиотекой",message_ua:"Не автризовані користувачи не можуть користуватися бібліотекою!",message_en:"Not auth users can't use library. Please  login!"},{code:"noData/available",message_ua:"Зараз тут пусто",message_ru:"Здесь сейчас пусто",message_en:"Now there is no films here"},{code:"films/place",message_ru:"Не правильно указан источник",message_ua:"Не правильно вказана папка ",message_en:"Invalid  folder"}],If={code:"default",message_ru:"Что-то пошло не так!",message_ua:"Упс Щось пішло не так!",message_en:"Oops. Something went wrong!"};function Ef(e,t="en"){const n=bf.find((({code:t})=>t===e));return n?n["message_"+t]:If["message_"+t]}new class{constructor(e,t="en"){console.log("constructor"),this.user=e,this.isLogin=!!e,this.language=t}}(null);var Cf=new WeakSet;async function Tf(){if(!this.refs)return!1;if(0===this.filmList.length){const e=await pf(df(this.refs,"/"));if(e.exists()){const t=e.val();this.filmList=Object.values(t).map((({id:e,title:t,genres:n,year:r,poster_path:i,vote:s,place:o})=>{const a=new Jn({id:e,title:t,genres:n,year:r,poster_path:i,vote:s});return a.place=o,a}))}return this.isReadFilm=!0,!0}}new class{setUid(e){e?(this.uid=e,this.refs=hf(this.db,"users/"+e)):(this.uid=null,this.refs=null,this.filmList=[]),this.isReadFilm=!1}async checkFilmInList(t,n){this.isReadFilm||await e(m)(this,Cf,Tf).call(this);for(let e=0;e<this.filmList.length;e+=1)if(this.filmList[e].id===t)return this.filmList[e].place=n,this.filmList[e];return null}async writeTo(e,t){if("QU"!=t&&"WA"!=t)return Ef("films/place",this.language);if(!this.uid)return Ef("auth/login",this.language);try{let n=await this.checkFilmInList(e.id,t);if(console.log("filmW:",n),!n){const{id:r,title:i,genres:s,release_date:o,poster_path:a,vote:c,language:l}=e;n=new Jn({id:r,title:i,genres:s,year:o,poster_path:a,vote:c,language:l}),n.place=t,this.filmList.push(n),console.log("writeTo this.filmList=",this.filmList)}return await ff(hf(this.db,"users/"+this.uid+"/"+n.id),n),""}catch(e){return Ef(e.code,this.language)}}async getFilms(t){if("QU"!=t&&"WA"!=t)return Ef("films/place",this.language);if(!this.refs)return Ef("auth/login",this.language);try{this.isReadFilm||await e(m)(this,Cf,Tf).call(this)}catch(e){return Ef(e.code,this.language)}return{films:this.filmList.filter((e=>e.place===t)),message:""}}constructor(t="en"){e(_)(this,Cf),this.db=wf,this.language=t,this.refs=null,this.filmList=[],this.uid=null,this.isReadFilm=!1}};const Sf=Qn();Sf.modeButton.addEventListener("click",(function(){document.body.classList.contains("moon")?(document.body.classList.remove("moon"),Sf.moon.classList.add("visually-hidden"),Sf.sun.classList.remove("visually-hidden"),localStorage.setItem("mode",!1)):(document.body.classList.add("moon"),localStorage.setItem("mode","moon"),Sf.sun.classList.add("visually-hidden"),Sf.moon.classList.remove("visually-hidden"))})),"moon"===localStorage.getItem("mode")&&(document.body.classList.add("moon"),Sf.sun.classList.add("visually-hidden"),Sf.moon.classList.remove("visually-hidden")),console.log("change4");
//# sourceMappingURL=index.f697be5b.js.map
