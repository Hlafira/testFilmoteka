 ...
 * limitations under the License.
 */
async function fa(e,{displayName:t,photoURL:n}){if(void 0===t&&void 0===n)return;const r=xi(e),i={idToken:await r.getIdToken(),displayName:t,photoUrl:n,returnSecureToken:!0},s=await uo(r,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var i,s;r.setAttribute("src",e),r.onload=t,r.onerror=e=>{const t=Us("internal-error");t.customData=e,n(t)},r.type="text/javascript",r.charset="UTF-8",(null!==(s=null===(i=document.getElementsByTagName("head"))||void 0===i?void 0:i[0])&&void 0!==s?s:document).appendChild(r)}))}function Aa(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Aa("rcb"),new Js(3e4,6e4);async function xa(e,t,n){var r;const i=await n.verify();try{let s;if(js("string"==typeof i,e,"argument-error"),js("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){js("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Da(e,t){return t?zs(t):(js(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nc=new Js(3e4,6e4);function rc(){const e=Ia().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ic=null;function sc(e){return ic=ic||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){rc(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{rc(),n(Us(e,"network-request-failed"))},timeout:nc.get()})}if(null===(i=null===(r=Ia().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Ia().gapi)||void 0===s?void 0:s.load)){const t=Aa("iframefcb");return Ia()[t]=()=>{gapi.load?o():n(Us(e,"network-request-failed"))},Oa(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw ic=null,e}))}(e),ic}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oc=new Js(5e3,15e3),ac={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},cc=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function lc(e){const t=e.config;js(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Ys(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,r={apiKey:t.apiKey,appName:e.name,v:"9.15.0"},i=cc.get(e.config.apiHost);i&&(r.eid=i);const s=e._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${Ei(r).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Ei(a).slice(1)}`}const pc=class{async _openPopup(e,t,n,r){var i;Ws(null===(i=this.eventManagers[e._key()])||void 0===i?void 0:i.manager,"_initialize() not called before _openPopup()");return dc(e,fc(e,t,n,$s(),r),wa())}async _openRedirect(e,t,n,r){var i;return await this._originValidation(e),i=fc(e,t,n,$s(),r),Ia().location.href=i,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(Ws(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await sc(e),n=Ia().gapi;return js(n,e,"internal-error"),t.open({where:document.body,url:lc(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:ac,dontclear:!0},(t=>new Promise((async(n,r)=>{await t.restyle({setHideOnLeave:!1});const i=Us(e,"network-request-failed"),s=Ia().setTimeout((()=>{r(i)}),oc.get());function o(){Ia().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{r(i)}))}))))}(e),n=new Ja(e);return t.register("authEvent",(t=>{js(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var r;const i=null===(r=null==n?void 0:n[0])||void 0===r?void 0:r.webStorageSupport;void 0!==i&&t(!!i),Ms(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ec(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Ao()||To()||Po()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ya,this._completeRedirectFn=Ga,this._overrideRedirectResult=$a}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const mc=oi("authIdTokenMaxAge")||300;let _c=null;var yc;yc="Browser",ps(new Li("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:s}=n.options;return((e,n)=>{js(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),js(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:s,clientPlatform:yc,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:xo(yc)},o=new Do(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(zs);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),ps(new Li("auth-internal",(e=>(e=>new gc(e))(Mo(e.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),ws("@firebase/auth","0.21.0",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(yc)),ws("@firebase/auth","0.21.0","esm2017");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new wc(t)}}catch(e){}return new bc},Ec=Ic("localStorage"),Tc=Ic("sessionStorage"),Cc=new zi("@firebase/database"),Sc=function(){let e=1;return function(){return e++}}(),kc=function(e){const t=Oi(e),n=new Si;n.update(t);const r=n.digest();return Hr.encodeByteArray(r)},Rc=function(...e){let t="";for(let n=0;n<e.length;n++){const r=e[n];Array.isArray(r)||r&&"object"==typeof r&&"number"==typeof r.length?t+=Rc.apply(null,r):t+="object"==typeof r?fi(r):r,t+=" "}return t};let Nc=null,Pc=!0;const Oc=function(e,t){jr(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?(Cc.logLevel=Fi.VERBOSE,Nc=Cc.log.bind(Cc),t&&Tc.set("logging_enabled",!0)):"function"==typeof e?Nc=e:(Nc=null,Tc.remove("logging_enabled"))},Ac=function(...e){if(!0===Pc&&(Pc=!1,null===Nc&&!0===Tc.get("logging_enabled")&&Oc(!0)),Nc){const t=Rc.apply(null,e);Nc(t)}},xc=function(e){return function(...t){Ac(e,...t)}},Lc=function(...e){const t="FIREBASE INTERNAL ERROR: "+Rc(...e);Cc.error(t)},Dc=function(...e){const t=`FIREBASE FATAL ERROR: ${Rc(...e)}`;throw Cc.error(t),new Error(t)},Mc=function(...e){const t="FIREBASE WARNING: "+Rc(...e);Cc.warn(t)},Uc=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},Fc=function(e,t){if(e===t)return 0;if("[MIN_NAME]"===e||"[MAX_NAME]"===t)return-1;if("[MIN_NAME]"===t||"[MAX_NAME]"===e)return 1;{const n=Vc(e),r=Vc(t);return null!==n?null!==r?n-r==0?e.length-t.length:n-r:-1:null!==r?1:e<t?-1:1}},Bc=function(e,t){return e===t?0:e<t?-1:1},jc=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+fi(t))},qc=function(e){if("object"!=typeof e||null===e)return fi(e);const t=[];for(const n in e)t.push(n);t.sort();let n="{";for(let r=0;r<t.length;r++)0!==r&&(n+=","),n+=fi(t[r]),n+=":",n+=qc(e[t[r]]);return n+="}",n},Wc=function(e,t){const n=e.length;if(n<=t)return[e];const r=[];for(let i=0;i<n;i+=t)i+t>n?r.push(e.substring(i,n)):r.push(e.substring(i,i+t));return r};function Hc(e,t){for(const n in e)e.hasOwnProperty(n)&&t(n,e[n])}const zc=function(e){jr(!Uc(e),"Invalid JSON number");const t=1023;let n,r,i,s,o;0===e?(r=0,i=0,n=1/e==-1/0?1:0):(n=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(s=Math.min(Math.floor(Math.log(e)/Math.LN2),t),r=s+t,i=Math.round(e*Math.pow(2,52-s)-Math.pow(2,52))):(r=0,i=Math.round(e/Math.pow(2,-1074))));const a=[];for(o=52;o;o-=1)a.push(i%2?1:0),i=Math.floor(i/2);for(o=11;o;o-=1)a.push(r%2?1:0),r=Math.floor(r/2);a.push(n?1:0),a.reverse();const c=a.join("");let l="";for(o=0;o<64;o+=8){let e=parseInt(c.substr(o,8),2).toString(16);1===e.length&&(e="0"+e),l+=e}return l.toLowerCase()};const $c=new RegExp("^-?(0*)\\d{1,10}$"),Vc=function(e){if($c.test(e)){const t=Number(e);if(t>=-2147483648&&t<=2147483647)return t}return null},Kc=function(e){try{e()}catch(e){setTimeout((()=>{const t=e.stack||"";throw Mc("Exception was thrown by user callback.",t),e}),Math.floor(0))}},Gc=function(e,t){const n=setTimeout(e,t);return"number"==typeof n&&"undefined"!=typeof Deno&&Deno.unrefTimer?Deno.unrefTimer(n):"object"==typeof n&&n.unref&&n.unref(),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zc{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Ec.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,r,i=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=r,this.nodeAdmin=i,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Ec.get("host:"+e)||this._host}}function el(e,t,n){let r;if(jr("string"==typeof t,"typeof type must == string"),jr("object"==typeof n,"typeof params must == object"),"websocket"===t)r=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);r=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const i=[];return Hc(n,((e,t)=>{i.push(e+"="+t)})),r+i.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ol extends fl{static getInstance(){return new Ol}getInitialEvent(e){return jr("visible"===e,"Unknown event type: "+e),[this.visible_]}constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new xl("[MIN_NAME]",e),r=new xl("[MIN_NAME]",t);return 0!==this.compare(n,r)}minPost(){return xl.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Dl;class Ml extends Ll{static get __EMPTY_NODE(){return Dl}static set __EMPTY_NODE(e){Dl=e}compare(e,t){return Fc(e.name,t.name)}isDefinedOn(e){throw qr("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return xl.MIN}maxPost(){return new xl("[MAX_NAME]",Dl)}makePost(e,t){return jr("string"==typeof e,"KeyIndex indexValue must always be a string."),new xl(e,Dl)}toString(){return".key"}}const Ul=new Ml;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function ql(e,t){return Fc(e.name,t.name)}function Wl(e,t){return Fc(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hl;jl.EMPTY_NODE=new class{copy(e,t,n,r,i){return this}insert(e,t,n){return new Bl(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const zl=function(e){return"number"==typeof e?"number:"+zc(e):"string:"+e},$l=function(e){if(e.isLeafNode()){const t=e.val();jr("string"==typeof t||"number"==typeof t||"object"==typeof t&&_i(t,".sv"),"Priority must be a string or number.")}else jr(e===Hl||e.isEmpty(),"priority of unexpected type.");jr(e===Hl||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let Vl,Kl,Gl;class Jl{static set __childrenNodeConstructor(e){Vl=e}static get __childrenNodeConstructor(){return Vl}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Jl(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Jl.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return Tl(e)?this:".priority"===_l(e)?this.priorityNode_:Jl.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Jl.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=_l(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(jr(".priority"!==n||1===yl(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Jl.__childrenNodeConstructor.EMPTY_NODE.updateChild(vl(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+zl(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?zc(this.value_):this.value_,this.lazyHash_=kc(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Jl.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Jl.__childrenNodeConstructor?-1:(jr(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,r=Jl.VALUE_TYPE_ORDER.indexOf(t),i=Jl.VALUE_TYPE_ORDER.indexOf(n);return jr(r>=0,"Unknown leaf type: "+t),jr(i>=0,"Unknown leaf type: "+n),r===i?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:i-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}constructor(e,t=Jl.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,jr(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),$l(this.priorityNode_)}}Jl.VALUE_TYPE_ORDER=["object","boolean","number","string"];const Yl=new class extends Ll{compare(e,t){const n=e.node.getPriority(),r=t.node.getPriority(),i=n.compareTo(r);return 0===i?Fc(e.name,t.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return xl.MIN}maxPost(){return new xl("[MAX_NAME]",new Jl("[PRIORITY-POST]",Gl))}makePost(e,t){const n=Kl(e);return new xl(t,new Jl("[PRIORITY-POST]",n))}toString(){return".priority"}},Ql=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let eu;const tu={};class nu{static get Default(){return jr(tu&&Yl,"ChildrenNode.ts has not been loaded"),eu=eu||new nu({".priority":tu},{".priority":Yl}),eu}get(e){const t=yi(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof jl?t:null}hasIndex(e){return _i(this.indexSet_,e.toString())}addIndex(e,t){jr(e!==Ul,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const i=t.getIterator(xl.Wrap);let s,o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=i.getNext();s=r?Zl(n,e.getCompare()):tu;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const l=Object.assign({},this.indexes_);return l[a]=s,new nu(l,c)}addToIndexes(e,t){const n=wi(this.indexes_,((n,r)=>{const i=yi(this.indexSet_,r);if(jr(i,"Missing index implementation for "+r),n===tu){if(i.isDefinedOn(e.node)){const n=[],r=t.getIterator(xl.Wrap);let s=r.getNext();for(;s;)s.name!==e.name&&n.push(s),s=r.getNext();return n.push(e),Zl(n,i.getCompare())}return tu}{const r=t.get(e.name);let i=n;return r&&(i=i.remove(new xl(e.name,r))),i.insert(e,e.node)}}));return new nu(n,this.indexSet_)}removeFromIndexes(e,t){const n=wi(this.indexes_,(n=>{if(n===tu)return n;{const r=t.get(e.name);return r?n.remove(new xl(e.name,r)):n}}));return new nu(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cu=new class extends Ll{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?Fc(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return xl.MIN}maxPost(){return xl.MAX}makePost(e,t){const n=ou(e);return new xl(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class fu{hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return jr(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return jr(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return jr(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return jr(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return jr(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Yl}copy(){const e=new fu;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Yl}}function pu(e){const t={};if(e.isDefault())return t;let n;if(e.index_===Yl?n="$priority":e.index_===cu?n="$value":e.index_===Ul?n="$key":(jr(e.index_ instanceof au,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=fi(n),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=fi(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+fi(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=fi(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+fi(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function gu(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Yl&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu extends dl{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(jr(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,r){const i=e._path.toString();this.log_("Listen called for "+i+" "+e._queryIdentifier);const s=mu.getListenId_(e,n),o={};this.listens_[s]=o;const a=pu(e._queryParams);this.restRequest_(i+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(i,a,!1,n),yi(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",r(t,null)}}))}unlisten(e,t){const n=mu.getListenId_(e,t);delete this.listens_[n]}get(e){const t=pu(e._queryParams),n=e._path.toString(),r=new ai;return this.restRequest_(n+".json",t,((e,t)=>{let i=t;404===e&&(i=null,e=null),null===e?(this.onDataUpdate_(n,i,!1,null),r.resolve(i)):r.reject(new Error(i))})),r.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([r,i])=>{r&&r.accessToken&&(t.auth=r.accessToken),i&&i.token&&(t.ac=i.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ei(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=di(o.responseText)}catch(e){Mc("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Mc("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}constructor(e,t,n,r){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=r,this.log_=xc("p:rest:"),this.listens_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _u{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=iu.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yu(){return{value:null,children:new Map}}function vu(e,t,n){if(Tl(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const r=_l(t);e.children.has(r)||e.children.set(r,yu());vu(e.children.get(r),t=vl(t),n)}}function wu(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{wu(r,new gl(t.toString()+"/"+e),n)}))}class bu{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Hc(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Hc(e,((e,r)=>{r>0&&_i(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),Gc(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new bu(e);const n=1e4+2e4*Math.random();Gc(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Tu=Eu||(Eu={}))[Tu.OVERWRITE=0]="OVERWRITE",Tu[Tu.MERGE=1]="MERGE",Tu[Tu.ACK_USER_WRITE=2]="ACK_USER_WRITE",Tu[Tu.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Su{operationForChild(e){if(Tl(this.path)){if(null!=this.affectedTree.value)return jr(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new gl(e));return new Su(ml(),t,this.revert)}}return jr(_l(this.path)===e,"operationForChild called for unrelated child."),new Su(vl(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Eu.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ku{operationForChild(e){return Tl(this.path)?new ku(this.source,ml(),this.snap.getImmediateChild(e)):new ku(this.source,vl(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Eu.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ru{operationForChild(e){if(Tl(this.path)){const t=this.children.subtree(new gl(e));return t.isEmpty()?null:t.value?new ku(this.source,ml(),t.value):new Ru(this.source,ml(),t)}return jr(_l(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ru(this.source,vl(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Eu.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pu(e,t,n,r,i,s){const o=r.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw qr("Should only compare child_ events.");const r=new xl(t.childName,t.snapshotNode),i=new xl(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);i.forEach((i=>{i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function Ou(e,t){return{eventCache:e,serverCache:t}}function Au(e,t,n,r){return Ou(new Nu(t,n,r),e.serverCache)}function xu(e,t,n,r){return Ou(e.eventCache,new Nu(t,n,r))}function Lu(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Du(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mu;class Uu{static fromObject(e){let t=new Uu(null);return Hc(e,((e,n)=>{t=t.set(new gl(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:ml(),value:this.value};if(Tl(e))return null;{const n=_l(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(vl(e),t);if(null!=i){return{path:El(new gl(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Tl(e))return this;{const t=_l(e),n=this.children.get(t);return null!==n?n.subtree(vl(e)):new Uu(null)}}set(e,t){if(Tl(e))return new Uu(t,this.children);{const n=_l(e),r=(this.children.get(n)||new Uu(null)).set(vl(e),t),i=this.children.insert(n,r);return new Uu(this.value,i)}}remove(e){if(Tl(e))return this.children.isEmpty()?new Uu(null):new Uu(null,this.children);{const t=_l(e),n=this.children.get(t);if(n){const r=n.remove(vl(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new Uu(null):new Uu(this.value,i)}return this}}get(e){if(Tl(e))return this.value;{const t=_l(e),n=this.children.get(t);return n?n.get(vl(e)):null}}setTree(e,t){if(Tl(e))return t;{const n=_l(e),r=(this.children.get(n)||new Uu(null)).setTree(vl(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new Uu(this.value,i)}}fold(e){return this.fold_(ml(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(El(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,ml(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Tl(e))return null;{const r=_l(e),i=this.children.get(r);return i?i.findOnPath_(vl(e),El(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ml(),t)}foreachOnPath_(e,t,n){if(Tl(e))return this;{this.value&&n(t,this.value);const r=_l(e),i=this.children.get(r);return i?i.foreachOnPath_(vl(e),El(t,r),n):new Uu(null)}}foreach(e){this.foreach_(ml(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(El(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(Mu||(Mu=new jl(Bc)),Mu))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fu{static empty(){return new Fu(new Uu(null))}constructor(e){this.writeTree_=e}}function Bu(e,t,n){if(Tl(t))return new Fu(new Uu(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=Cl(i,t);return s=s.updateChild(o,n),new Fu(e.writeTree_.set(i,s))}{const r=new Uu(n),i=e.writeTree_.setTree(t,r);return new Fu(i)}}}function ju(e,t,n){let r=e;return Hc(n,((e,n)=>{r=Bu(r,El(t,e),n)})),r}function qu(e,t){if(Tl(t))return Fu.empty();{const n=e.writeTree_.setTree(t,new Uu(null));return new Fu(n)}}function Wu(e,t){return null!=Hu(e,t)}function Hu(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Cl(n.path,t)):null}function zu(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Yl,((e,n)=>{t.push(new xl(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new xl(e,n.value))})),t}function $u(e,t){if(Tl(t))return e;{const n=Hu(e,t);return new Fu(null!=n?new Uu(n):e.writeTree_.subtree(t))}}function Vu(e){return e.writeTree_.isEmpty()}function Ku(e,t){return Gu(ml(),e.writeTree_,t)}function Gu(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?(jr(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=Gu(El(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(El(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ju(e,t){return ch(t,e)}function Yu(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));jr(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let i=r.visible,s=!1,o=e.allWrites.length-1;for(;i&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&Qu(t,r.path)?i=!1:kl(r.path,t.path)&&(s=!0)),o--}if(i){if(s)return function(e){e.visibleWrites=Zu(e.allWrites,Xu,ml()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=qu(e.visibleWrites,r.path);else{Hc(r.children,(t=>{e.visibleWrites=qu(e.visibleWrites,El(r.path,t))}))}return!0}return!1}function Qu(e,t){if(e.snap)return kl(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&kl(El(e.path,n),t))return!0;return!1}function Xu(e){return e.visible}function Zu(e,t,n){let r=Fu.empty();for(let i=0;i<e.length;++i){const s=e[i];if(t(s)){const e=s.path;let t;if(s.snap)kl(n,e)?(t=Cl(n,e),r=Bu(r,t,s.snap)):kl(e,n)&&(t=Cl(e,n),r=Bu(r,ml(),s.snap.getChild(t)));else{if(!s.children)throw qr("WriteRecord should have .snap or .children");if(kl(n,e))t=Cl(n,e),r=ju(r,t,s.children);else if(kl(e,n))if(t=Cl(e,n),Tl(t))r=ju(r,ml(),s.children);else{const e=yi(s.children,_l(t));if(e){const n=e.getChild(vl(t));r=Bu(r,ml(),n)}}}}}return r}function eh(e,t,n,r,i){if(r||i){const s=$u(e.visibleWrites,t);if(!i&&Vu(s))return n;if(i||null!=n||Wu(s,ml())){const s=function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(kl(e.path,t)||kl(t,e.path))};return Ku(Zu(e.allWrites,s,t),n||iu.EMPTY_NODE)}return null}{const r=Hu(e.visibleWrites,t);if(null!=r)return r;{const r=$u(e.visibleWrites,t);if(Vu(r))return n;if(null!=n||Wu(r,ml())){return Ku(r,n||iu.EMPTY_NODE)}return null}}}function th(e,t,n,r){return eh(e.writeTree,e.treePath,t,n,r)}function nh(e,t){return function(e,t,n){let r=iu.EMPTY_NODE;const i=Hu(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild(Yl,((e,t)=>{r=r.updateImmediateChild(e,t)})),r;if(n){const i=$u(e.visibleWrites,t);return n.forEachChild(Yl,((e,t)=>{const n=Ku($u(i,new gl(e)),t);r=r.updateImmediateChild(e,n)})),zu(i).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}return zu($u(e.visibleWrites,t)).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function rh(e,t,n,r){return function(e,t,n,r,i){jr(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=El(t,n);if(Wu(e.visibleWrites,s))return null;{const t=$u(e.visibleWrites,s);return Vu(t)?i.getChild(n):Ku(t,i.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function ih(e,t){return function(e,t){return Hu(e.visibleWrites,t)}(e.writeTree,El(e.treePath,t))}function sh(e,t,n,r,i,s){return function(e,t,n,r,i,s,o){let a;const c=$u(e.visibleWrites,t),l=Hu(c,ml());if(null!=l)a=l;else{if(null==n)return[];a=Ku(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let c=n.getNext();for(;c&&e.length<i;)0!==t(c,r)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,r,i,s)}function oh(e,t,n){return function(e,t,n,r){const i=El(t,n),s=Hu(e.visibleWrites,i);if(null!=s)return s;if(r.isCompleteForChild(n))return Ku($u(e.visibleWrites,i),r.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function ah(e,t){return ch(El(e.treePath,t),e.writeTree)}function ch(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lh{trackChildChange(e){const t=e.type,n=e.childName;jr("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),jr(".priority"!==n,"Only non-priority child changes can be tracked.");const r=this.changeMap.get(n);if(r){const i=r.type;if("child_added"===t&&"child_removed"===i)this.changeMap.set(n,du(n,e.snapshotNode,r.snapshotNode));else if("child_removed"===t&&"child_added"===i)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===i)this.changeMap.set(n,hu(n,r.oldSnap));else if("child_changed"===t&&"child_added"===i)this.changeMap.set(n,uu(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==i)throw qr("Illegal combination of changes: "+e+" occurred after "+r);this.changeMap.set(n,du(n,e.snapshotNode,r.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uh=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class hh{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Nu(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return oh(this.writes_,e,t)}}getChildAfterChild(e,t,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Du(this.viewCache_),i=sh(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dh(e,t,n,r,i){const s=new lh;let o,a;if(n.type===Eu.OVERWRITE){const c=n;c.source.fromUser?o=gh(e,t,c.path,c.snap,r,i,s):(jr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Tl(c.path),o=ph(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===Eu.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=El(n,r);mh(t,_l(l))&&(a=gh(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=El(n,r);mh(t,_l(l))||(a=gh(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(jr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=yh(e,t,c.path,c.children,r,i,a,s))}else if(n.type===Eu.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=ih(r,n))return t;{const a=new hh(r,t,i),c=t.eventCache.getNode();let l;if(Tl(n)||".priority"===_l(n)){let n;if(t.serverCache.isFullyInitialized())n=th(r,Du(t));else{const e=t.serverCache.getNode();jr(e instanceof iu,"serverChildren would be complete if leaf node"),n=nh(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=_l(n);let u=oh(r,i,t.serverCache);null==u&&t.serverCache.isCompleteForChild(i)&&(u=c.getImmediateChild(i)),l=null!=u?e.filter.updateChild(c,i,u,vl(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,iu.EMPTY_NODE,vl(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=th(r,Du(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=ih(r,ml()),Au(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,r,i,s):function(e,t,n,r,i,s,o){if(null!=ih(i,n))return t;const a=t.serverCache.isFiltered(),c=t.serverCache;if(null!=r.value){if(Tl(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return ph(e,t,n,c.getNode().getChild(n),i,s,a,o);if(Tl(n)){let r=new Uu(null);return c.getNode().forEachChild(Ul,((e,t)=>{r=r.set(new gl(e),t)})),yh(e,t,n,r,i,s,a,o)}return t}{let l=new Uu(null);return r.foreach(((e,t)=>{const r=El(n,e);c.isCompleteForPath(r)&&(l=l.set(e,c.getNode().getChild(r)))})),yh(e,t,n,l,i,s,a,o)}}(e,t,a.path,a.affectedTree,r,i,s)}else{if(n.type!==Eu.LISTEN_COMPLETE)throw qr("Unknown operation type: "+n.type);o=function(e,t,n,r,i){const s=t.serverCache,o=xu(t,s.getNode(),s.isFullyInitialized()||Tl(n),s.isFiltered());return fh(e,o,n,r,uh,i)}(e,t,n.path,r,s)}const c=s.getChanges();return function(e,t,n){const r=t.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=Lu(e);(n.length>0||!e.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(lu(Lu(t)))}}(t,o,c),{viewCache:o,changes:c}}function fh(e,t,n,r,i,s){const o=t.eventCache;if(null!=ih(r,n))return t;{let a,c;if(Tl(n))if(jr(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Du(t),i=nh(r,n instanceof iu?n:iu.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),i,s)}else{const n=th(r,Du(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const l=_l(n);if(".priority"===l){jr(1===yl(n),"Can't have a priority with additional path components");const i=o.getNode();c=t.serverCache.getNode();const s=rh(r,n,i,c);a=null!=s?e.filter.updatePriority(i,s):o.getNode()}else{const u=vl(n);let h;if(o.isCompleteForChild(l)){c=t.serverCache.getNode();const e=rh(r,n,o.getNode(),c);h=null!=e?o.getNode().getImmediateChild(l).updateChild(u,e):o.getNode().getImmediateChild(l)}else h=oh(r,l,t.serverCache);a=null!=h?e.filter.updateChild(o.getNode(),l,h,u,i,s):o.getNode()}}return Au(t,a,o.isFullyInitialized()||Tl(n),e.filter.filtersNodes())}}function ph(e,t,n,r,i,s,o,a){const c=t.serverCache;let l;const u=o?e.filter:e.filter.getIndexedFilter();if(Tl(n))l=u.updateFullNode(c.getNode(),r,null);else if(u.filtersNodes()&&!c.isFiltered()){const e=c.getNode().updateChild(n,r);l=u.updateFullNode(c.getNode(),e,null)}else{const e=_l(n);if(!c.isCompleteForPath(n)&&yl(n)>1)return t;const i=vl(n),s=c.getNode().getImmediateChild(e).updateChild(i,r);l=".priority"===e?u.updatePriority(c.getNode(),s):u.updateChild(c.getNode(),e,s,i,uh,null)}const h=xu(t,l,c.isFullyInitialized()||Tl(n),u.filtersNodes());return fh(e,h,n,i,new hh(i,h,s),a)}function gh(e,t,n,r,i,s,o){const a=t.eventCache;let c,l;const u=new hh(i,t,s);if(Tl(n))l=e.filter.updateFullNode(t.eventCache.getNode(),r,o),c=Au(t,l,!0,e.filter.filtersNodes());else{const i=_l(n);if(".priority"===i)l=e.filter.updatePriority(t.eventCache.getNode(),r),c=Au(t,l,a.isFullyInitialized(),a.isFiltered());else{const s=vl(n),l=a.getNode().getImmediateChild(i);let h;if(Tl(s))h=r;else{const e=u.getCompleteChild(i);h=null!=e?".priority"===wl(s)&&e.getChild(Il(s)).isEmpty()?e:e.updateChild(s,r):iu.EMPTY_NODE}if(l.equals(h))c=t;else{c=Au(t,e.filter.updateChild(a.getNode(),i,h,s,u,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return c}function mh(e,t){return e.eventCache.isCompleteForChild(t)}function _h(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function yh(e,t,n,r,i,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let c,l=t;c=Tl(n)?r:new Uu(null).setTree(n,r);const u=t.serverCache.getNode();return c.children.inorderTraversal(((n,r)=>{if(u.hasChild(n)){const c=_h(0,t.serverCache.getNode().getImmediateChild(n),r);l=ph(e,l,new gl(n),c,i,s,o,a)}})),c.children.inorderTraversal(((n,r)=>{const c=!t.serverCache.isCompleteForChild(n)&&null===r.value;if(!u.hasChild(n)&&!c){const c=_h(0,t.serverCache.getNode().getImmediateChild(n),r);l=ph(e,l,new gl(n),c,i,s,o,a)}})),l}function vh(e,t){const n=Du(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Tl(t)&&!n.getImmediateChild(_l(t)).isEmpty())?n.getChild(t):null}function wh(e,t,n,r){t.type===Eu.MERGE&&null!==t.source.queryId&&(jr(Du(e.viewCache_),"We should always have a full cache before handling merges"),jr(Lu(e.viewCache_),"Missing event cache, even though we have a server cache"));const i=e.viewCache_,s=dh(e.processor_,i,t,n,r);var o,a;return o=e.processor_,a=s.viewCache,jr(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),jr(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),jr(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,bh(e,s.changes,s.viewCache.eventCache.getNode(),null)}function bh(e,t,n,r){const i=r?[r]:e.eventRegistrations_;return function(e,t,n,r){const i=[],s=[];return t.forEach((t=>{var n;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Pu(e,i,"child_removed",t,r,n),Pu(e,i,"child_added",t,r,n),Pu(e,i,"child_moved",s,r,n),Pu(e,i,"child_changed",t,r,n),Pu(e,i,"value",t,r,n),i}(e.eventGenerator_,t,n,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ih,Eh;function Th(e,t,n,r){const i=t.source.queryId;if(null!==i){const s=e.views.get(i);return jr(null!=s,"SyncTree gave us an op for an invalid query."),wh(s,t,n,r)}{let i=[];for(const s of e.views.values())i=i.concat(wh(s,t,n,r));return i}}function Ch(e,t){let n=null;for(const r of e.views.values())n=n||vh(r,t);return n}class Sh{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Uu(null),this.pendingWriteTree_={visibleWrites:Fu.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function kh(e,t,n,r,i){return function(e,t,n,r,i){jr(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=Bu(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?Ah(e,new ku({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Rh(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if(Yu(e.pendingWriteTree_,t)){let t=new Uu(null);return null!=r.snap?t=t.set(ml(),!0):Hc(r.children,(e=>{t=t.set(new gl(e),!0)})),Ah(e,new Su(r.path,t,n))}return[]}function Nh(e,t,n){return Ah(e,new ku({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Ph(e,t,n,r){const i=Dh(e,r);if(null!=i){const r=Mh(i),s=r.path,o=r.queryId,a=Cl(s,t);return Uh(e,s,new ku(Cu(o),a,n))}return[]}function Oh(e,t,n){const r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,((e,n)=>{const r=Ch(n,Cl(e,t));if(r)return r}));return eh(r,t,i,n,!0)}function Ah(e,t){return xh(t,e.syncPointTree_,null,Ju(e.pendingWriteTree_,ml()))}function xh(e,t,n,r){if(Tl(e.path))return Lh(e,t,n,r);{const i=t.get(ml());null==n&&null!=i&&(n=Ch(i,ml()));let s=[];const o=_l(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=ah(r,o);s=s.concat(xh(a,c,e,t))}return i&&(s=s.concat(Th(i,e,r,n))),s}}function Lh(e,t,n,r){const i=t.get(ml());null==n&&null!=i&&(n=Ch(i,ml()));let s=[];return t.children.inorderTraversal(((t,i)=>{const o=n?n.getImmediateChild(t):null,a=ah(r,t),c=e.operationForChild(t);c&&(s=s.concat(Lh(c,i,o,a)))})),i&&(s=s.concat(Th(i,e,r,n))),s}function Dh(e,t){return e.tagToQueryMap.get(t)}function Mh(e){const t=e.indexOf("$");return jr(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new gl(e.substr(0,t))}}function Uh(e,t,n){const r=e.syncPointTree_.get(t);jr(r,"Missing sync point for query tag that we're tracking");return Th(r,n,Ju(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Fh{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Fh(t)}node(){return this.node_}constructor(e){this.node_=e}}class Bh{getImmediateChild(e){const t=El(this.path_,e);return new Bh(this.syncTree_,t)}node(){return Oh(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const jh=function(e,t,n){return e&&"object"==typeof e?(jr(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?qh(e[".sv"],t,n):"object"==typeof e[".sv"]?Wh(e[".sv"],t):void jr(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},qh=function(e,t,n){if("timestamp"===e)return n.timestamp;jr(!1,"Unexpected server value: "+e)},Wh=function(e,t,n){e.hasOwnProperty("increment")||jr(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&jr(!1,"Unexpected increment value: "+r);const i=t.node();if(jr(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const s=i.getValue();return"number"!=typeof s?r:s+r},Hh=function(e,t,n,r){return $h(t,new Bh(n,e),r)},zh=function(e,t,n){return $h(e,new Fh(t),n)};function $h(e,t,n){const r=e.getPriority().val(),i=jh(r,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const r=e,s=jh(r.getValue(),t,n);return s!==r.getValue()||i!==r.getPriority().val()?new Jl(s,ou(i)):e}{const r=e;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new Jl(i))),r.forEachChild(Yl,((e,r)=>{const i=$h(r,t.getImmediateChild(e),n);i!==r&&(s=s.updateImmediateChild(e,i))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vh{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Kh(e,t){let n=t instanceof gl?t:new gl(t),r=e,i=_l(n);for(;null!==i;){const e=yi(r.node.children,i)||{children:{},childCount:0};r=new Vh(i,r,e),n=vl(n),i=_l(n)}return r}function Gh(e){return e.node.value}function Jh(e,t){e.node.value=t,ed(e)}function Yh(e){return e.node.childCount>0}function Qh(e,t){Hc(e.node.children,((n,r)=>{t(new Vh(n,e,r))}))}function Xh(e,t,n,r){n&&!r&&t(e),Qh(e,(e=>{Xh(e,t,!0,r)})),n&&r&&t(e)}function Zh(e){return new gl(null===e.parent?e.name:Zh(e.parent)+"/"+e.name)}function ed(e){null!==e.parent&&function(e,t,n){const r=function(e){return void 0===Gh(e)&&!Yh(e)}(n),i=_i(e.node.children,t);r&&i?(delete e.node.children[t],e.node.childCount--,ed(e)):r||i||(e.node.children[t]=n.node,e.node.childCount++,ed(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const td=/[\[\].#$\/\u0000-\u001F\u007F]/,nd=/[\[\].#$\u0000-\u001F\u007F]/,rd=function(e){return"string"==typeof e&&0!==e.length&&!td.test(e)},id=function(e){return"string"==typeof e&&0!==e.length&&!nd.test(e)},sd=function(e,t,n){const r=n instanceof gl?new Rl(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Pl(r));if("function"==typeof t)throw new Error(e+"contains a function "+Pl(r)+" with contents = "+t.toString());if(Uc(t))throw new Error(e+"contains "+t.toString()+" "+Pl(r));if("string"==typeof t&&t.length>10485760/3&&Ai(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Pl(r)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,i=!1;if(Hc(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(i=!0,!rd(t)))throw new Error(e+" contains an invalid key ("+t+") "+Pl(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=r).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=Ai(a),Nl(o),sd(e,s,r),function(e){const t=e.parts_.pop();e.byteLength_-=Ai(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),n&&i)throw new Error(e+' contains ".value" child '+Pl(r)+" in addition to actual children.")}},od=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!rd(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),id(e)}(n))throw new Error(Pi(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ad{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function cd(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||Sl(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function ld(e,t,n){cd(e,n),ud(e,(e=>kl(e,t)||kl(t,e)))}function ud(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(hd(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function hd(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();Nc&&Ac("event: "+n.toString()),Kc(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dd{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new ad,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=yu(),this.transactionQueueTree_=new Vh,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function fd(e,t,n){if(e.stats_=il(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new mu(e.repoInfo_,((t,n,r,i)=>{md(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>_d(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{fi(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Al(e.repoInfo_,t,((t,n,r,i)=>{md(e,t,n,r,i)}),(t=>{_d(e,t)}),(t=>{!function(e,t){Hc(t,((t,n)=>{yd(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return rl[n]||(rl[n]=t()),rl[n]}(e.repoInfo_,(()=>new Iu(e.stats_,e.server_))),e.infoData_=new _u,e.infoSyncTree_=new Sh({startListening:(t,n,r,i)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Nh(e.infoSyncTree_,t._path,o),setTimeout((()=>{i("ok")}),0)),s},stopListening:()=>{}}),yd(e,"connected",!1),e.serverSyncTree_=new Sh({startListening:(t,n,r,i)=>(e.server_.listen(t,r,n,((n,r)=>{const s=i(n,r);ld(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function pd(e){const t=e.infoData_.getNode(new gl(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function gd(e){return(t=(t={timestamp:pd(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function md(e,t,n,r,i){e.dataUpdateCount++;const s=new gl(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(i)if(r){const t=wi(n,(e=>ou(e)));o=function(e,t,n,r){const i=Dh(e,r);if(i){const r=Mh(i),s=r.path,o=r.queryId,a=Cl(s,t),c=Uu.fromObject(n);return Uh(e,s,new Ru(Cu(o),a,c))}return[]}(e.serverSyncTree_,s,t,i)}else{const t=ou(n);o=Ph(e.serverSyncTree_,s,t,i)}else if(r){const t=wi(n,(e=>ou(e)));o=function(e,t,n){const r=Uu.fromObject(n);return Ah(e,new Ru({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,s,t)}else{const t=ou(n);o=Nh(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=Td(e,s)),ld(e.eventQueue_,a,o)}function _d(e,t){yd(e,"connected",t),!1===t&&function(e){bd(e,"onDisconnectEvents");const t=gd(e),n=yu();wu(e.onDisconnect_,ml(),((r,i)=>{const s=Hh(r,i,e.serverSyncTree_,t);vu(n,r,s)}));let r=[];wu(n,ml(),((t,n)=>{r=r.concat(Nh(e.serverSyncTree_,t,n));const i=Nd(e,t);Td(e,i)})),e.onDisconnect_=yu(),ld(e.eventQueue_,ml(),r)}(e)}function yd(e,t,n){const r=new gl("/.info/"+t),i=ou(n);e.infoData_.updateSnapshot(r,i);const s=Nh(e.infoSyncTree_,r,i);ld(e.eventQueue_,r,s)}function vd(e){return e.nextWriteId_++}function wd(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function bd(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Ac(n,...t)}function Id(e,t,n){return Oh(e.serverSyncTree_,t,n)||iu.EMPTY_NODE}function Ed(e,t=e.transactionQueueTree_){if(t||Rd(e,t),Gh(t)){const n=Sd(e,t);jr(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const r=n.map((e=>e.currentWriteId)),i=Id(e,t,r);let s=i;const o=i.hash();for(let e=0;e<n.length;e++){const r=n[e];jr(0===r.status,"tryToSendTransactionQueue_: items in queue should all be run."),r.status=1,r.retryCount++;const i=Cl(t,r.path);s=s.updateChild(i,r.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(r=>{bd(e,"transaction put response",{path:c.toString(),status:r});let i=[];if("ok"===r){const r=[];for(let t=0;t<n.length;t++)n[t].status=2,i=i.concat(Rh(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&r.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Rd(e,Kh(e.transactionQueueTree_,t)),Ed(e,e.transactionQueueTree_),ld(e.eventQueue_,t,i);for(let e=0;e<r.length;e++)Kc(r[e])}else{if("datastale"===r)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Mc("transaction at "+c.toString()+" failed: "+r);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=r}Td(e,t)}}),o)}(e,Zh(t),n)}else Yh(t)&&Qh(t,(t=>{Ed(e,t)}))}function Td(e,t){const n=Cd(e,t),r=Zh(n);return function(e,t,n){if(0===t.length)return;const r=[];let i=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=Cl(n,c.path);let u,h=!1;if(jr(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)h=!0,u=c.abortReason,i=i.concat(Rh(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)h=!0,u="maxretry",i=i.concat(Rh(e.serverSyncTree_,c.currentWriteId,!0));else{const n=Id(e,c.path,s);c.currentInputSnapshot=n;const r=t[a].update(n.val());if(void 0!==r){sd("transaction failed: Data returned ",r,c.path);let t=ou(r);"object"==typeof r&&null!=r&&_i(r,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=gd(e),l=zh(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=vd(e),s.splice(s.indexOf(o),1),i=i.concat(kh(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),i=i.concat(Rh(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",i=i.concat(Rh(e.serverSyncTree_,c.currentWriteId,!0))}ld(e.eventQueue_,n,i),i=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?r.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):r.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;Rd(e,e.transactionQueueTree_);for(let e=0;e<r.length;e++)Kc(r[e]);Ed(e,e.transactionQueueTree_)}(e,Sd(e,n),r),r}function Cd(e,t){let n,r=e.transactionQueueTree_;for(n=_l(t);null!==n&&void 0===Gh(r);)r=Kh(r,n),n=_l(t=vl(t));return r}function Sd(e,t){const n=[];return kd(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function kd(e,t,n){const r=Gh(t);if(r)for(let e=0;e<r.length;e++)n.push(r[e]);Qh(t,(t=>{kd(e,t,n)}))}function Rd(e,t){const n=Gh(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Jh(t,n.length>0?n:void 0)}Qh(t,(t=>{Rd(e,t)}))}function Nd(e,t){const n=Zh(Cd(e,t)),r=Kh(e.transactionQueueTree_,t);return function(e,t,n){let r=n?e:e.parent;for(;null!==r;){if(t(r))return!0;r=r.parent}}(r,(t=>{Pd(e,t)})),Pd(e,r),Xh(r,(t=>{Pd(e,t)})),n}function Pd(e,t){const n=Gh(t);if(n){const r=[];let i=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(jr(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(jr(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),i=i.concat(Rh(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&r.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Jh(t,void 0):n.length=s+1,ld(e.eventQueue_,Zh(t),i);for(let e=0;e<r.length;e++)Kc(r[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class xd{get key(){return Tl(this._path)?null:wl(this._path)}get ref(){return new Ld(this._repo,this._path)}get _queryIdentifier(){const e=gu(this._queryParams),t=qc(e);return"{}"===t?"default":t}get _queryObject(){return gu(this._queryParams)}isEqual(e){if(!((e=xi(e))instanceof xd))return!1;const t=this._repo===e._repo,n=Sl(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class Ld extends xd{get parent(){const e=Il(this._path);return null===e?null:new Ld(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new fu,!1)}}!function(e){jr(!Ih,"__referenceConstructor has already been defined"),Ih=e}(Ld),function(e){jr(!Eh,"__referenceConstructor has already been defined"),Eh=e}(Ld);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Dd={};let Md=!1;function Ud(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||Dc("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ac("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=Od(s,i),l=c.repoInfo;void 0!==Ir&&Ir.env&&(a=Ir.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=Od(s,i),l=c.repoInfo):o=!c.repoInfo.secure;const u=i&&o?new Qc(Qc.OWNER):new Yc(e.name,e.options,t);od("Invalid Firebase Database URL",c),Tl(c.path)||Dc("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,r){let i=Dd[t.name];i||(i={},Dd[t.name]=i);let s=i[e.toURLString()];s&&Dc("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new dd(e,Md,n,r),i[e.toURLString()]=s,s}(l,e,u,new Jc(e.name,n));return new Fd(h,e)}class Fd{get _repo(){return this._instanceStarted||(fd(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ld(this._repo,ml())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Dd[t];n&&n[e.key]===e||Dc(`Database ${t}(${e.repoInfo_}) has already been deleted.`),wd(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Dc("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}Al.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Al.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){vc="9.15.0",ps(new Li("database",((e,{instanceIdentifier:t})=>Ud(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ws("@firebase/database","0.14.0",e),ws("@firebase/database","0.14.0","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Bd=ys({apiKey:"AIzaSyCDhc_FFOW788b9xS67xRCHGL2Falcnxko",authDomain:"filmoteks-fs61.firebaseapp.com",projectId:"filmoteks-fs61",storageBucket:"filmoteks-fs61.appspot.com",messagingSenderId:"392503967659",appId:"1:392503967659:web:7720f7b1803ed8583b9cee",measurementId:"G-JLEERBJV8V",databaseURL:"https://filmoteks-fs61-default-rtdb.europe-west1.firebasedatabase.app"}),jd=function(e=vs()){const t=gs(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=gs(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(bi(n.getOptions(),null!=t?t:{}))return e;Ms(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:pc,persistence:[Pa,ma,ya]}),r=oi("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>mc)return;const r=null==t?void 0:t.token;_c!==r&&(_c=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){xi(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){xi(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=ii("auth");return s&&Fo(n,`http://${s}`),n}(Bd),qd=(function(e=vs(),t){const n=gs(e,"database").getImmediate({identifier:t}),r=si("database");r&&function(e,t,n,r={}){(e=xi(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&Dc("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&Dc('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new Qc(Qc.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:ci(r.mockUserToken,e.app.options.projectId);s=new Qc(t)}!function(e,t,n,r){e.repoInfo_=new Zc(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),r&&(e.authTokenProvider_=r)}(i,t,n,s)}(n,...r)}(Bd),[{code:"auth/user-not-found",massage_ru:"Пользователь с такой почтой и паролем не найден",message_ua:"Користувача за цією поштою або паролем не знайдено ",message_en:"User with this password or email don'n found "},{code:"auth/network-request-failed",massage_ru:"Ошибка подключения . Проверьте наличие интернета.",message_ua:"Помилка підключення. Перевірте наявність інтернета",message_en:"Network error!"},{code:"auth/email-already-in-use",massage_ru:"Пользователь с такой почтой уже зарегистрирован!",message_ua:"Користувач з такую поштою вже в системі!",message_en:"This email already in use!"},{code:"auth/login",massage_ru:"Не авторизированные пользователи не могут пользоваться библиотекой",message_ua:"Не автризовані користувачи не можуть користуватися бібліотекою!",message_en:"Not auth users can't use library. Please  login!"},{code:"noData/available",message_ua:"Зараз тут пусто",message_ru:"Здесь сейчас пусто",message_en:"Now there is no films here"},{code:"films/place",message_ru:"Не правильно указан источник",message_ua:"Не правильно вказана папка ",message_en:"Invalid  folder"}]),Wd={code:"default",message_ru:"Что-то пошло не так!",message_ua:"Упс Щось пішло не так!",message_en:"Oops. Something went wrong!"};function Hd(e,t="en"){const n=qd.find((({code:t})=>t===e));return n?n["message_"+t]:Wd["message_"+t]}function zd(e,t){console.log("RenderLoginMainPage =",e,"user=",t)}const $d=new class{getUserDisplayName(){return this.isLogin?this.user.displayName&&this.user.displayName.length>0?this.user.displayName:this.user.email:""}getUserUid(){return this.isLogin?this.user?.uid:null}async login(e,t){try{const n=await da(jd,e,t);return this.user=n.user,""}catch(e){return Hd(e.code,this.language)}}async singUp(e,t,n=""){try{const r=await ha(auth,e,t);return this.user=r.user,n.length,await fa(this.user,{displayName:n}),""}catch(e){return Hd(e.code,this.language)}}async logOut(){if(!this.isLogin)return"";try{return await jd.signOut(),""}catch(e){return Hd(e.code,this.language)}}constructor(e,t="en"){console.log("constructor"),this.user=e,this.isLogin=!!e,this.language=t}}(null);jd.onAuthStateChanged((e=>{e?($d.user=e,$d.isLogin=!0):($d.user=null,$d.isLogin=!1),zd($d.isLogin,$d.getUserDisplayName())}));const Vd=Qn();Vd.modeButton.addEventListener("click",(function(){document.body.classList.contains("moon")?(document.body.classList.remove("moon"),Vd.moon.classList.add("visually-hidden"),Vd.sun.classList.remove("visually-hidden"),localStorage.setItem("mode",!1)):(document.body.classList.add("moon"),localStorage.setItem("mode","moon"),Vd.sun.classList.add("visually-hidden"),Vd.moon.classList.remove("visually-hidden"))})),"moon"===localStorage.getItem("mode")&&(document.body.classList.add("moon"),Vd.sun.classList.add("visually-hidden"),Vd.moon.classList.remove("visually-hidden")),document.querySelector(".footer").addEventListener("click",(()=>{!async function(){const e=await $d.logOut();console.log(e)}()})),document.querySelector(".header").addEventListener("click",(()=>{console.log("login"),async function(){const e=await $d.singUp("some19email@mail.com","anypassword","some");console.log(e),console.log($d.getUserDisplayName())}()})),console.log("change10");
//# sourceMappingURL=index.b887b8ee.js.map
