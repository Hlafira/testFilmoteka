 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ps;Ps="",ps(new Li("platform-logger",(e=>new cs(e)),"PRIVATE")),ps(new Li("heartbeat",(e=>new Ts(e)),"PRIVATE")),ws("@firebase/app","0.9.0",Ps),ws("@firebase/app","0.9.0","esm2017"),ws("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bc{set(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t}get(e){return _i(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}constructor(){this.cache_={},this.isInMemoryStorage=!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic=function(e){try{if("undefined"!=typeof window&&void 0!==window[e]){const t=window[e];return t.setItem("firebase:sentinel","cache"),t.removeItem("firebase:sentinel"),new wc(t)}}catch(e){}return new bc},Ec=Ic("localStorage"),Cc=Ic("sessionStorage"),Tc=new zi("@firebase/database"),Sc=function(){let e=1;return function(){return e++}}(),kc=function(e){const t=Oi(e),n=new Si;n.update(t);const r=n.digest();return Hr.encodeByteArray(r)},Rc=function(...e){let t="";for(let n=0;n<e.length;n++){const r=e[n];Array.isArray(r)||r&&"object"==typeof r&&"number"==typeof r.length?t+=Rc.apply(null,r):t+="object"==typeof r?fi(r):r,t+=" "}return t};let Pc=null,Nc=!0;const Oc=function(e,t){qr(!t||!0===e||!1===e,"Can't turn on custom loggers persistently."),!0===e?(Tc.logLevel=Fi.VERBOSE,Pc=Tc.log.bind(Tc),t&&Cc.set("logging_enabled",!0)):"function"==typeof e?Pc=e:(Pc=null,Cc.remove("logging_enabled"))},xc=function(...e){if(!0===Nc&&(Nc=!1,null===Pc&&!0===Cc.get("logging_enabled")&&Oc(!0)),Pc){const t=Rc.apply(null,e);Pc(t)}},Ac=function(e){return function(...t){xc(e,...t)}},Lc=function(...e){const t="FIREBASE INTERNAL ERROR: "+Rc(...e);Tc.error(t)},Dc=function(...e){const t=`FIREBASE FATAL ERROR: ${Rc(...e)}`;throw Tc.error(t),new Error(t)},Mc=function(...e){const t="FIREBASE WARNING: "+Rc(...e);Tc.warn(t)},Uc=function(e){return"number"==typeof e&&(e!=e||e===Number.POSITIVE_INFINITY||e===Number.NEGATIVE_INFINITY)},Fc=function(e,t){if(e===t)return 0;if("[MIN_NAME]"===e||"[MAX_NAME]"===t)return-1;if("[MIN_NAME]"===t||"[MAX_NAME]"===e)return 1;{const n=Vc(e),r=Vc(t);return null!==n?null!==r?n-r==0?e.length-t.length:n-r:-1:null!==r?1:e<t?-1:1}},Bc=function(e,t){return e===t?0:e<t?-1:1},qc=function(e,t){if(t&&e in t)return t[e];throw new Error("Missing required key ("+e+") in object: "+fi(t))},jc=function(e){if("object"!=typeof e||null===e)return fi(e);const t=[];for(const n in e)t.push(n);t.sort();let n="{";for(let r=0;r<t.length;r++)0!==r&&(n+=","),n+=fi(t[r]),n+=":",n+=jc(e[t[r]]);return n+="}",n},Wc=function(e,t){const n=e.length;if(n<=t)return[e];const r=[];for(let i=0;i<n;i+=t)i+t>n?r.push(e.substring(i,n)):r.push(e.substring(i,i+t));return r};function Hc(e,t){for(const n in e)e.hasOwnProperty(n)&&t(n,e[n])}const zc=function(e){qr(!Uc(e),"Invalid JSON number");const t=1023;let n,r,i,s,o;0===e?(r=0,i=0,n=1/e==-1/0?1:0):(n=e<0,(e=Math.abs(e))>=Math.pow(2,-1022)?(s=Math.min(Math.floor(Math.log(e)/Math.LN2),t),r=s+t,i=Math.round(e*Math.pow(2,52-s)-Math.pow(2,52))):(r=0,i=Math.round(e/Math.pow(2,-1074))));const a=[];for(o=52;o;o-=1)a.push(i%2?1:0),i=Math.floor(i/2);for(o=11;o;o-=1)a.push(r%2?1:0),r=Math.floor(r/2);a.push(n?1:0),a.reverse();const c=a.join("");let l="";for(o=0;o<64;o+=8){let e=parseInt(c.substr(o,8),2).toString(16);1===e.length&&(e="0"+e),l+=e}return l.toLowerCase()};const $c=new RegExp("^-?(0*)\\d{1,10}$"),Vc=function(e){if($c.test(e)){const t=Number(e);if(t>=-2147483648&&t<=2147483647)return t}return null},Kc=function(e){try{e()}catch(e){setTimeout((()=>{const t=e.stack||"";throw Mc("Exception was thrown by user callback.",t),e}),Math.floor(0))}},Gc=function(e,t){const n=setTimeout(e,t);return"number"==typeof n&&"undefined"!=typeof Deno&&Deno.unrefTimer?Deno.unrefTimer(n):"object"==typeof n&&n.unref&&n.unref(),n};
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Jc{getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise(((t,n)=>{setTimeout((()=>{this.appCheck?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){var t;null===(t=this.appCheckProvider)||void 0===t||t.get().then((t=>t.addTokenListener(e)))}notifyForInvalidToken(){Mc(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=null==t?void 0:t.getImmediate({optional:!0}),this.appCheck||null==t||t.get().then((e=>this.appCheck=e))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yc{getToken(e){return this.auth_?this.auth_.getToken(e).catch((e=>e&&"auth/token-not-initialized"===e.code?(xc("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e))):new Promise(((t,n)=>{setTimeout((()=>{this.auth_?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((t=>t.addAuthTokenListener(e)))}removeTokenChangeListener(e){this.authProvider_.get().then((t=>t.removeAuthTokenListener(e)))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Mc(e)}constructor(e,t,n){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit((e=>this.auth_=e))}}class Qc{getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}constructor(e){this.accessToken=e}}Qc.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Xc=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zc{isCacheableHost(){return"s-"===this.internalHost.substr(0,2)}isCustomHost(){return"firebaseio.com"!==this._domain&&"firebaseio-demo.com"!==this._domain}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Ec.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}constructor(e,t,n,r,i=!1,s="",o=!1){this.secure=t,this.namespace=n,this.webSocketOnly=r,this.nodeAdmin=i,this.persistenceKey=s,this.includeNamespaceInQueryParams=o,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Ec.get("host:"+e)||this._host}}function el(e,t,n){let r;if(qr("string"==typeof t,"typeof type must == string"),qr("object"==typeof n,"typeof params must == object"),"websocket"===t)r=(e.secure?"wss://":"ws://")+e.internalHost+"/.ws?";else{if("long_polling"!==t)throw new Error("Unknown connection type: "+t);r=(e.secure?"https://":"http://")+e.internalHost+"/.lp?"}(function(e){return e.host!==e.internalHost||e.isCustomHost()||e.includeNamespaceInQueryParams})(e)&&(n.ns=e.namespace);const i=[];return Hc(n,((e,t)=>{i.push(e+"="+t)})),r+i.join("&")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tl{incrementCounter(e,t=1){_i(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Kr(this.counters_)}constructor(){this.counters_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nl={},rl={};function il(e){const t=e.toString();return nl[t]||(nl[t]=new tl),nl[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class sl{closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&Kc((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ol{open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new sl(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout((()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null}),Math.floor(3e4)),function(e){if(ei()||"complete"===document.readyState)e();else{let t=!1;const n=function(){document.body?t||(t=!0,e()):setTimeout(n,Math.floor(10))};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",(()=>{"complete"===document.readyState&&n()})),window.attachEvent("onload",n))}}((()=>{if(this.isClosed_)return;this.scriptTagHolder=new al(((...e)=>{const[t,n,r,i,s]=e;if(this.incrementIncomingBytes_(e),this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,"start"===t)this.id=n,this.password=r;else{if("close"!==t)throw new Error("Unrecognized command received: "+t);n?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(n,(()=>{this.onClosed_()}))):this.onClosed_()}}),((...e)=>{const[t,n]=e;this.incrementIncomingBytes_(e),this.myPacketOrderer.handleResponse(t,n)}),(()=>{this.onClosed_()}),this.urlFn);const e={start:"t"};e.ser=Math.floor(1e8*Math.random()),this.scriptTagHolder.uniqueCallbackIdentifier&&(e.cb=this.scriptTagHolder.uniqueCallbackIdentifier),e.v="5",this.transportSessionId&&(e.s=this.transportSessionId),this.lastSessionId&&(e.ls=this.lastSessionId),this.applicationId&&(e.p=this.applicationId),this.appCheckToken&&(e.ac=this.appCheckToken),"undefined"!=typeof location&&location.hostname&&Xc.test(location.hostname)&&(e.r="f");const t=this.urlFn(e);this.log_("Connecting via long-poll to "+t),this.scriptTagHolder.addTag(t,(()=>{}))}))}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){ol.forceAllow_=!0}static forceDisallow(){ol.forceDisallow_=!0}static isAvailable(){return!ei()&&(!!ol.forceAllow_||!(ol.forceDisallow_||"undefined"==typeof document||null==document.createElement||"object"==typeof window&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href)||"object"==typeof Windows&&"object"==typeof Windows.UI))}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=fi(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=zr(t),r=Wc(n,1840);for(let e=0;e<r.length;e++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[e]),this.curSegmentNum++}addDisconnectPingFrame(e,t){if(ei())return;this.myDisconnFrame=document.createElement("iframe");const n={dframe:"t"};n.id=e,n.pw=t,this.myDisconnFrame.src=this.urlFn(n),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=fi(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}constructor(e,t,n,r,i,s,o){this.connId=e,this.repoInfo=t,this.applicationId=n,this.appCheckToken=r,this.authToken=i,this.transportSessionId=s,this.lastSessionId=o,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Ac(e),this.stats_=il(t),this.urlFn=e=>(this.appCheckToken&&(e.ac=this.appCheckToken),el(t,"long_polling",e))}}class al{static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",!document.body)throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";document.body.appendChild(e);try{e.contentWindow.document||xc("No IE domain setting required")}catch(t){const n=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+n+"';document.close();})())"}return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout((()=>{null!==this.myIFrame&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)}),Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e.id=this.myID,e.pw=this.myPW,e.ser=this.currentSerial;let t=this.urlFn(e),n="",r=0;for(;this.pendingSegs.length>0;){if(!(this.pendingSegs[0].d.length+30+n.length<=1870))break;{const e=this.pendingSegs.shift();n=n+"&seg"+r+"="+e.seg+"&ts"+r+"="+e.ts+"&d"+r+"="+e.d,r++}}return t+=n,this.addLongPollTag_(t,this.currentSerial),!0}return!1}enqueueSegment(e,t,n){this.pendingSegs.push({seg:e,ts:t,d:n}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const n=()=>{this.outstandingRequests.delete(t),this.newRequest_()},r=setTimeout(n,Math.floor(25e3));this.addTag(e,(()=>{clearTimeout(r),n()}))}addTag(e,t){ei()?this.doNodeLongPoll(e,t):setTimeout((()=>{try{if(!this.sendNewPolls)return;const n=this.myIFrame.doc.createElement("script");n.type="text/javascript",n.async=!0,n.src=e,n.onload=n.onreadystatechange=function(){const e=n.readyState;e&&"loaded"!==e&&"complete"!==e||(n.onload=n.onreadystatechange=null,n.parentNode&&n.parentNode.removeChild(n),t())},n.onerror=()=>{xc("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(n)}catch(e){}}),Math.floor(1))}constructor(e,t,n,r){if(this.onDisconnect=n,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(1e8*Math.random()),this.sendNewPolls=!0,ei())this.commandCB=e,this.onMessageCB=t;else{this.uniqueCallbackIdentifier=Sc(),window["pLPCommand"+this.uniqueCallbackIdentifier]=e,window["pRTLPCB"+this.uniqueCallbackIdentifier]=t,this.myIFrame=al.createIFrame_();let n="";if(this.myIFrame.src&&"javascript:"===this.myIFrame.src.substr(0,11)){n='<script>document.domain="'+document.domain+'";<\/script>'}const r="<html><body>"+n+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(e){xc("frame writing exception"),e.stack&&xc(e.stack),xc(e)}}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cl=null;"undefined"!=typeof MozWebSocket?cl=MozWebSocket:"undefined"!=typeof WebSocket&&(cl=WebSocket);class ll{static connectionURL_(e,t,n,r,i){const s={v:"5"};return!ei()&&"undefined"!=typeof location&&location.hostname&&Xc.test(location.hostname)&&(s.r="f"),t&&(s.s=t),n&&(s.ls=n),r&&(s.ac=r),i&&(s.p=i),el(e,"websocket",s)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Ec.set("previous_websocket_failure",!0);try{let e;if(ei()){const t=this.nodeAdmin?"AdminNode":"Node";e={headers:{"User-Agent":`Firebase/5/${vc}/${Ir.platform}/${t}`,"X-Firebase-GMPID":this.applicationId||""}},this.authToken&&(e.headers.Authorization=`Bearer ${this.authToken}`),this.appCheckToken&&(e.headers["X-Firebase-AppCheck"]=this.appCheckToken);const n={},r=0===this.connURL.indexOf("wss://")?n.HTTPS_PROXY||n.https_proxy:n.HTTP_PROXY||n.http_proxy;r&&(e.proxy={origin:r})}this.mySock=new cl(this.connURL,[],e)}catch(e){this.log_("Error instantiating WebSocket.");const t=e.message||e.data;return t&&this.log_(t),void this.onClosed_()}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=e=>{this.handleIncomingFrame(e)},this.mySock.onerror=e=>{this.log_("WebSocket error.  Closing connection.");const t=e.message||e.data;t&&this.log_(t),this.onClosed_()}}start(){}static forceDisallow(){ll.forceDisallow_=!0}static isAvailable(){let e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,n=navigator.userAgent.match(t);n&&n.length>1&&parseFloat(n[1])<4.4&&(e=!0)}return!e&&null!==cl&&!ll.forceDisallow_}static previouslyFailed(){return Ec.isInMemoryStorage||!0===Ec.get("previous_websocket_failure")}markConnectionHealthy(){Ec.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const e=this.frames.join("");this.frames=null;const t=di(e);this.onMessage(t)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(qr(null===this.frames,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(null===this.mySock)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),null!==this.frames)this.appendFrame_(t);else{const e=this.extractFrameCount_(t);null!==e&&this.appendFrame_(e)}}send(e){this.resetKeepAlive();const t=fi(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=Wc(t,16384);n.length>1&&this.sendString_(String(n.length));for(let e=0;e<n.length;e++)this.sendString_(n[e])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval((()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()}),Math.floor(45e3))}sendString_(e){try{this.mySock.send(e)}catch(e){this.log_("Exception thrown from WebSocket.send():",e.message||e.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}constructor(e,t,n,r,i,s,o){this.connId=e,this.applicationId=n,this.appCheckToken=r,this.authToken=i,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=Ac(this.connId),this.stats_=il(t),this.connURL=ll.connectionURL_(t,s,o,r,n),this.nodeAdmin=t.nodeAdmin}}ll.responsesRequiredToBeHealthy=2,ll.healthyTimeout=3e4;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ul{static get ALL_TRANSPORTS(){return[ol,ll]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}initTransports_(e){const t=ll&&ll.isAvailable();let n=t&&!ll.previouslyFailed();if(e.webSocketOnly&&(t||Mc("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),n=!0),n)this.transports_=[ll];else{const e=this.transports_=[];for(const t of ul.ALL_TRANSPORTS)t&&t.isAvailable()&&e.push(t);ul.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}constructor(e){this.initTransports_(e)}}ul.globalTransportInitialized_=!1;class hl{start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.conn_),n=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout((()=>{this.conn_&&this.conn_.open(t,n)}),Math.floor(0));const r=e.healthyTimeout||0;r>0&&(this.healthyTimeout_=Gc((()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>102400?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>10240?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))}),Math.floor(r)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return t=>{e===this.conn_?this.onConnectionLost_(t):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return t=>{2!==this.state_&&(e===this.rx_?this.onPrimaryMessageReceived_(t):e===this.secondaryConn_?this.onSecondaryMessageReceived_(t):this.log_("message on old connection"))}}sendRequest(e){const t={t:"d",d:e};this.sendData_(t)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if("t"in e){const t=e.t;"a"===t?this.upgradeIfSecondaryHealthy_():"r"===t?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),this.tx_!==this.secondaryConn_&&this.rx_!==this.secondaryConn_||this.close()):"o"===t&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const t=qc("t",e),n=qc("d",e);if("c"===t)this.onSecondaryControl_(n);else{if("d"!==t)throw new Error("Unknown protocol layer: "+t);this.pendingDataMessages.push(n)}}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:"p",d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:"a",d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:"n",d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const t=qc("t",e),n=qc("d",e);"c"===t?this.onControl_(n):"d"===t&&this.onDataMessage_(n)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const t=qc("t",e);if("d"in e){const n=e.d;if("h"===t)this.onHandshake_(n);else if("n"===t){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let e=0;e<this.pendingDataMessages.length;++e)this.onDataMessage_(this.pendingDataMessages[e]);this.pendingDataMessages=[],this.tryCleanupConnection()}else"s"===t?this.onConnectionShutdown_(n):"r"===t?this.onReset_(n):"e"===t?Lc("Server Error: "+n):"o"===t?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):Lc("Unknown control packet command: "+t)}}onHandshake_(e){const t=e.ts,n=e.v,r=e.h;this.sessionId=e.s,this.repoInfo_.host=r,0===this.state_&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,t),"5"!==n&&Mc("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.secondaryConn_),n=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(t,n),Gc((()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())}),Math.floor(6e4))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,1===this.state_?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,t){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(t,this.sessionId),this.onReady_=null),0===this.primaryResponsesRequired_?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):Gc((()=>{this.sendPingOnPrimaryIfNecessary_()}),Math.floor(5e3))}sendPingOnPrimaryIfNecessary_(){this.isHealthy_||1!==this.state_||(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:"p",d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,this.tx_!==e&&this.rx_!==e||this.close()}onConnectionLost_(e){this.conn_=null,e||0!==this.state_?1===this.state_&&this.log_("Realtime connection lost."):(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(Ec.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(1!==this.state_)throw"Connection is not connected";this.tx_.send(e)}close(){2!==this.state_&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}constructor(e,t,n,r,i,s,o,a,c,l){this.id=e,this.repoInfo_=t,this.applicationId_=n,this.appCheckToken_=r,this.authToken_=i,this.onMessage_=s,this.onReady_=o,this.onDisconnect_=a,this.onKill_=c,this.lastSessionId=l,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=Ac("c:"+this.id+":"),this.transportManager_=new ul(t),this.log_("Connection created"),this.start_()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dl{put(e,t,n,r){}merge(e,t,n,r){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,t,n){}onDisconnectMerge(e,t,n){}onDisconnectCancel(e,t){}reportStats(e){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fl{trigger(e,...t){if(Array.isArray(this.listeners_[e])){const n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});const r=this.getInitialEvent(e);r&&t.apply(n,r)}off(e,t,n){this.validateEventType_(e);const r=this.listeners_[e]||[];for(let e=0;e<r.length;e++)if(r[e].callback===t&&(!n||n===r[e].context))return void r.splice(e,1)}validateEventType_(e){qr(this.allowedEvents_.find((t=>t===e)),"Unknown event: "+e)}constructor(e){this.allowedEvents_=e,this.listeners_={},qr(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl{toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}}function ml(){return new gl("")}function _l(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function yl(e){return e.pieces_.length-e.pieceNum_}function vl(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new gl(e.pieces_,t)}function wl(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function bl(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function Il(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new gl(t,0)}function El(e,t){const n=[];for(let t=e.pieceNum_;t<e.pieces_.length;t++)n.push(e.pieces_[t]);if(t instanceof gl)for(let e=t.pieceNum_;e<t.pieces_.length;e++)n.push(t.pieces_[e]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new gl(n,0)}function Cl(e){return e.pieceNum_>=e.pieces_.length}function Tl(e,t){const n=_l(e),r=_l(t);if(null===n)return t;if(n===r)return Tl(vl(e),vl(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function Sl(e,t){if(yl(e)!==yl(t))return!1;for(let n=e.pieceNum_,r=t.pieceNum_;n<=e.pieces_.length;n++,r++)if(e.pieces_[n]!==t.pieces_[r])return!1;return!0}function kl(e,t){let n=e.pieceNum_,r=t.pieceNum_;if(yl(e)>yl(t))return!1;for(;n<e.pieces_.length;){if(e.pieces_[n]!==t.pieces_[r])return!1;++n,++r}return!0}class Rl{constructor(e,t){this.errorPrefix_=t,this.parts_=bl(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let e=0;e<this.parts_.length;e++)this.byteLength_+=xi(this.parts_[e]);Pl(this)}}function Pl(e){if(e.byteLength_>768)throw new Error(e.errorPrefix_+"has a key path longer than 768 bytes ("+e.byteLength_+").");if(e.parts_.length>32)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written (32) or object contains a cycle "+Nl(e))}function Nl(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ol extends fl{static getInstance(){return new Ol}getInitialEvent(e){return qr("visible"===e,"Unknown event type: "+e),[this.visible_]}constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new Al("[MIN_NAME]",e),r=new Al("[MIN_NAME]",t);return 0!==this.compare(n,r)}minPost(){return Al.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Dl;class Ml extends Ll{static get __EMPTY_NODE(){return Dl}static set __EMPTY_NODE(e){Dl=e}compare(e,t){return Fc(e.name,t.name)}isDefinedOn(e){throw jr("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Al.MIN}maxPost(){return new Al("[MAX_NAME]",Dl)}makePost(e,t){return qr("string"==typeof e,"KeyIndex indexValue must always be a string."),new Al(e,Dl)}toString(){return".key"}}const Ul=new Ml;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function jl(e,t){return Fc(e.name,t.name)}function Wl(e,t){return Fc(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hl;ql.EMPTY_NODE=new class{copy(e,t,n,r,i){return this}insert(e,t,n){return new Bl(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const zl=function(e){return"number"==typeof e?"number:"+zc(e):"string:"+e},$l=function(e){if(e.isLeafNode()){const t=e.val();qr("string"==typeof t||"number"==typeof t||"object"==typeof t&&_i(t,".sv"),"Priority must be a string or number.")}else qr(e===Hl||e.isEmpty(),"priority of unexpected type.");qr(e===Hl||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let Vl,Kl,Gl;class Jl{static set __childrenNodeConstructor(e){Vl=e}static get __childrenNodeConstructor(){return Vl}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Jl(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:Jl.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return Cl(e)?this:".priority"===_l(e)?this.priorityNode_:Jl.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:Jl.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=_l(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(qr(".priority"!==n||1===yl(e),".priority must be the last token in a path"),this.updateImmediateChild(n,Jl.__childrenNodeConstructor.EMPTY_NODE.updateChild(vl(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+zl(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?zc(this.value_):this.value_,this.lazyHash_=kc(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Jl.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Jl.__childrenNodeConstructor?-1:(qr(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,r=Jl.VALUE_TYPE_ORDER.indexOf(t),i=Jl.VALUE_TYPE_ORDER.indexOf(n);return qr(r>=0,"Unknown leaf type: "+t),qr(i>=0,"Unknown leaf type: "+n),r===i?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:i-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}constructor(e,t=Jl.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,qr(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),$l(this.priorityNode_)}}Jl.VALUE_TYPE_ORDER=["object","boolean","number","string"];const Yl=new class extends Ll{compare(e,t){const n=e.node.getPriority(),r=t.node.getPriority(),i=n.compareTo(r);return 0===i?Fc(e.name,t.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Al.MIN}maxPost(){return new Al("[MAX_NAME]",new Jl("[PRIORITY-POST]",Gl))}makePost(e,t){const n=Kl(e);return new Al(t,new Jl("[PRIORITY-POST]",n))}toString(){return".priority"}},Ql=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xl{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/Ql,10)),this.current_=this.count-1;const n=(r=this.count,parseInt(Array(r+1).join("1"),2));var r;this.bits_=e+1&n}}const Zl=function(e,t,n,r){e.sort(t);const i=function(t,r){const s=r-t;let o,a;if(0===s)return null;if(1===s)return o=e[t],a=n?n(o):o,new Bl(a,o.node,Bl.BLACK,null,null);{const c=parseInt(s/2,10)+t,l=i(t,c),u=i(c+1,r);return o=e[c],a=n?n(o):o,new Bl(a,o.node,Bl.BLACK,l,u)}},s=function(t){let r=null,s=null,o=e.length;const a=function(t,r){const s=o-t,a=o;o-=t;const l=i(s+1,a),u=e[s],h=n?n(u):u;c(new Bl(h,u.node,r,null,l))},c=function(e){r?(r.left=e,r=e):(s=e,r=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),r=Math.pow(2,t.count-(e+1));n?a(r,Bl.BLACK):(a(r,Bl.BLACK),a(r,Bl.RED))}return s}(new Xl(e.length));return new ql(r||t,s)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let eu;const tu={};class nu{static get Default(){return qr(tu&&Yl,"ChildrenNode.ts has not been loaded"),eu=eu||new nu({".priority":tu},{".priority":Yl}),eu}get(e){const t=yi(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof ql?t:null}hasIndex(e){return _i(this.indexSet_,e.toString())}addIndex(e,t){qr(e!==Ul,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const i=t.getIterator(Al.Wrap);let s,o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=i.getNext();s=r?Zl(n,e.getCompare()):tu;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const l=Object.assign({},this.indexes_);return l[a]=s,new nu(l,c)}addToIndexes(e,t){const n=wi(this.indexes_,((n,r)=>{const i=yi(this.indexSet_,r);if(qr(i,"Missing index implementation for "+r),n===tu){if(i.isDefinedOn(e.node)){const n=[],r=t.getIterator(Al.Wrap);let s=r.getNext();for(;s;)s.name!==e.name&&n.push(s),s=r.getNext();return n.push(e),Zl(n,i.getCompare())}return tu}{const r=t.get(e.name);let i=n;return r&&(i=i.remove(new Al(e.name,r))),i.insert(e,e.node)}}));return new nu(n,this.indexSet_)}removeFromIndexes(e,t){const n=wi(this.indexes_,(n=>{if(n===tu)return n;{const r=t.get(e.name);return r?n.remove(new Al(e.name,r)):n}}));return new nu(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ru;class iu{static get EMPTY_NODE(){return ru||(ru=new iu(new ql(Wl),null,nu.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||ru}updatePriority(e){return this.children_.isEmpty()?this:new iu(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?ru:t}}getChild(e){const t=_l(e);return null===t?this:this.getImmediateChild(t).getChild(vl(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(qr(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new Al(e,t);let r,i;t.isEmpty()?(r=this.children_.remove(e),i=this.indexMap_.removeFromIndexes(n,this.children_)):(r=this.children_.insert(e,t),i=this.indexMap_.addToIndexes(n,this.children_));const s=r.isEmpty()?ru:this.priorityNode_;return new iu(r,s,i)}}updateChild(e,t){const n=_l(e);if(null===n)return t;{qr(".priority"!==_l(e)||1===yl(e),".priority must be the last token in a path");const r=this.getImmediateChild(n).updateChild(vl(e),t);return this.updateImmediateChild(n,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,r=0,i=!0;if(this.forEachChild(Yl,((s,o)=>{t[s]=o.val(e),n++,i&&iu.INTEGER_REGEXP_.test(s)?r=Math.max(r,Number(s)):i=!1})),!e&&i&&r<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+zl(this.getPriority().val())+":"),this.forEachChild(Yl,((t,n)=>{const r=n.hash();""!==r&&(e+=":"+t+":"+r)})),this.lazyHash_=""===e?"":kc(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const r=this.resolveIndex_(n);if(r){const n=r.getPredecessorKey(new Al(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new Al(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new Al(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,Al.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)<0;)n.getNext(),r=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,Al.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)>0;)n.getNext(),r=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===su?-1:0}withIndex(e){if(e===Ul||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new iu(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Ul||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(Yl),n=t.getIterator(Yl);let r=e.getNext(),i=n.getNext();for(;r&&i;){if(r.name!==i.name||!r.node.equals(i.node))return!1;r=e.getNext(),i=n.getNext()}return null===r&&null===i}return!1}return!1}}resolveIndex_(e){return e===Ul?null:this.indexMap_.get(e.toString())}constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&$l(this.priorityNode_),this.children_.isEmpty()&&qr(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}}iu.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const su=new class extends iu{compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return iu.EMPTY_NODE}isEmpty(){return!1}constructor(){super(new ql(Wl),iu.EMPTY_NODE,nu.Default)}};Object.defineProperties(Al,{MIN:{value:new Al("[MIN_NAME]",iu.EMPTY_NODE)},MAX:{value:new Al("[MAX_NAME]",su)}}),Ml.__EMPTY_NODE=iu.EMPTY_NODE,Jl.__childrenNodeConstructor=iu,Hl=su,function(e){Gl=e}(su);function ou(e,t=null){if(null===e)return iu.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),qr(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new Jl(e,ou(t))}if(e instanceof Array){let n=iu.EMPTY_NODE;return Hc(e,((t,r)=>{if(_i(e,t)&&"."!==t.substring(0,1)){const e=ou(r);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(ou(t))}{const n=[];let r=!1;if(Hc(e,((e,t)=>{if("."!==e.substring(0,1)){const i=ou(t);i.isEmpty()||(r=r||!i.getPriority().isEmpty(),n.push(new Al(e,i)))}})),0===n.length)return iu.EMPTY_NODE;const i=Zl(n,jl,(e=>e.name),Wl);if(r){const e=Zl(n,Yl.getCompare());return new iu(i,ou(t),new nu({".priority":e},{".priority":Yl}))}return new iu(i,ou(t),nu.Default)}}!function(e){Kl=e}(ou);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class au extends Ll{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?Fc(e.name,t.name):i}makePost(e,t){const n=ou(e),r=iu.EMPTY_NODE.updateChild(this.indexPath_,n);return new Al(t,r)}maxPost(){const e=iu.EMPTY_NODE.updateChild(this.indexPath_,su);return new Al("[MAX_NAME]",e)}toString(){return bl(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,qr(!Cl(e)&&".priority"!==_l(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cu=new class extends Ll{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?Fc(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Al.MIN}maxPost(){return Al.MAX}makePost(e,t){const n=ou(e);return new Al(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lu(e){return{type:"value",snapshotNode:e}}function uu(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function hu(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function du(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class fu{updateChild(e,t,n,r,i,s){qr(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(r).equals(n.getChild(r))&&o.isEmpty()===n.isEmpty()?e:(null!=s&&(n.isEmpty()?e.hasChild(t)?s.trackChildChange(hu(t,o)):qr(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?s.trackChildChange(uu(t,n)):s.trackChildChange(du(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(Yl,((e,r)=>{t.hasChild(e)||n.trackChildChange(hu(e,r))})),t.isLeafNode()||t.forEachChild(Yl,((t,r)=>{if(e.hasChild(t)){const i=e.getImmediateChild(t);i.equals(r)||n.trackChildChange(du(t,r,i))}else n.trackChildChange(uu(t,r))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?iu.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}constructor(e){this.index_=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pu{getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,n=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&n}updateChild(e,t,n,r,i,s){return this.matches(new Al(t,n))||(n=iu.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,r,i,s)}updateFullNode(e,t,n){t.isLeafNode()&&(t=iu.EMPTY_NODE);let r=t.withIndex(this.index_);r=r.updatePriority(iu.EMPTY_NODE);const i=this;return t.forEachChild(Yl,((e,t)=>{i.matches(new Al(e,t))||(r=r.updateImmediateChild(e,iu.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}constructor(e){this.indexedFilter_=new fu(e.getIndex()),this.index_=e.getIndex(),this.startPost_=pu.getStartPost_(e),this.endPost_=pu.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gu{updateChild(e,t,n,r,i,s){return this.rangedFilter_.matches(new Al(t,n))||(n=iu.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,r,i,s):this.fullLimitUpdateChild_(e,t,n,i,s)}updateFullNode(e,t,n){let r;if(t.isLeafNode()||t.isEmpty())r=iu.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;r=iu.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();if(this.withinDirectionalStart(t)){if(!this.withinDirectionalEnd(t))break;r=r.updateImmediateChild(t.name,t.node),n++}}}else{let e;r=t.withIndex(this.index_),r=r.updatePriority(iu.EMPTY_NODE),e=this.reverse_?r.getReverseIterator(this.index_):r.getIterator(this.index_);let n=0;for(;e.hasNext();){const t=e.getNext();n<this.limit_&&this.withinDirectionalStart(t)&&this.withinDirectionalEnd(t)?n++:r=r.updateImmediateChild(t.name,iu.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,r,i){let s;if(this.reverse_){const e=this.index_.getCompare();s=(t,n)=>e(n,t)}else s=this.index_.getCompare();const o=e;qr(o.numChildren()===this.limit_,"");const a=new Al(t,n),c=this.reverse_?o.getFirstChild(this.index_):o.getLastChild(this.index_),l=this.rangedFilter_.matches(a);if(o.hasChild(t)){const e=o.getImmediateChild(t);let u=r.getChildAfterChild(this.index_,c,this.reverse_);for(;null!=u&&(u.name===t||o.hasChild(u.name));)u=r.getChildAfterChild(this.index_,u,this.reverse_);const h=null==u?1:s(u,a);if(l&&!n.isEmpty()&&h>=0)return null!=i&&i.trackChildChange(du(t,n,e)),o.updateImmediateChild(t,n);{null!=i&&i.trackChildChange(hu(t,e));const n=o.updateImmediateChild(t,iu.EMPTY_NODE);return null!=u&&this.rangedFilter_.matches(u)?(null!=i&&i.trackChildChange(uu(u.name,u.node)),n.updateImmediateChild(u.name,u.node)):n}}return n.isEmpty()?e:l&&s(c,a)>=0?(null!=i&&(i.trackChildChange(hu(c.name,c.node)),i.trackChildChange(uu(t,n))),o.updateImmediateChild(t,n).updateImmediateChild(c.name,iu.EMPTY_NODE)):e}constructor(e){this.withinDirectionalStart=e=>this.reverse_?this.withinEndPost(e):this.withinStartPost(e),this.withinDirectionalEnd=e=>this.reverse_?this.withinStartPost(e):this.withinEndPost(e),this.withinStartPost=e=>{const t=this.index_.compare(this.rangedFilter_.getStartPost(),e);return this.startIsInclusive_?t<=0:t<0},this.withinEndPost=e=>{const t=this.index_.compare(e,this.rangedFilter_.getEndPost());return this.endIsInclusive_?t<=0:t<0},this.rangedFilter_=new pu(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu{hasStart(){return this.startSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return qr(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return qr(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return qr(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return qr(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return qr(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===Yl}copy(){const e=new mu;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=Yl}}function _u(e){const t={};if(e.isDefault())return t;let n;if(e.index_===Yl?n="$priority":e.index_===cu?n="$value":e.index_===Ul?n="$key":(qr(e.index_ instanceof au,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=fi(n),e.startSet_){const n=e.startAfterSet_?"startAfter":"startAt";t[n]=fi(e.indexStartValue_),e.startNameSet_&&(t[n]+=","+fi(e.indexStartName_))}if(e.endSet_){const n=e.endBeforeSet_?"endBefore":"endAt";t[n]=fi(e.indexEndValue_),e.endNameSet_&&(t[n]+=","+fi(e.indexEndName_))}return e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function yu(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_),t.sin=!e.startAfterSet_),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_),t.ein=!e.endBeforeSet_),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==Yl&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu extends dl{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(qr(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,r){const i=e._path.toString();this.log_("Listen called for "+i+" "+e._queryIdentifier);const s=vu.getListenId_(e,n),o={};this.listens_[s]=o;const a=_u(e._queryParams);this.restRequest_(i+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(i,a,!1,n),yi(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",r(t,null)}}))}unlisten(e,t){const n=vu.getListenId_(e,t);delete this.listens_[n]}get(e){const t=_u(e._queryParams),n=e._path.toString(),r=new ai;return this.restRequest_(n+".json",t,((e,t)=>{let i=t;404===e&&(i=null,e=null),null===e?(this.onDataUpdate_(n,i,!1,null),r.resolve(i)):r.reject(new Error(i))})),r.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([r,i])=>{r&&r.accessToken&&(t.auth=r.accessToken),i&&i.token&&(t.ac=i.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ei(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=di(o.responseText)}catch(e){Mc("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Mc("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}constructor(e,t,n,r){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=r,this.log_=Ac("p:rest:"),this.listens_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wu{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=iu.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bu(){return{value:null,children:new Map}}function Iu(e,t,n){if(Cl(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const r=_l(t);e.children.has(r)||e.children.set(r,bu());Iu(e.children.get(r),t=vl(t),n)}}function Eu(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{Eu(r,new gl(t.toString()+"/"+e),n)}))}class Cu{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Hc(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tu{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Hc(e,((e,r)=>{r>0&&_i(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),Gc(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Cu(e);const n=1e4+2e4*Math.random();Gc(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Su,ku;function Ru(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(ku=Su||(Su={}))[ku.OVERWRITE=0]="OVERWRITE",ku[ku.MERGE=1]="MERGE",ku[ku.ACK_USER_WRITE=2]="ACK_USER_WRITE",ku[ku.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Pu{operationForChild(e){if(Cl(this.path)){if(null!=this.affectedTree.value)return qr(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new gl(e));return new Pu(ml(),t,this.revert)}}return qr(_l(this.path)===e,"operationForChild called for unrelated child."),new Pu(vl(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Su.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nu{operationForChild(e){return Cl(this.path)?new Nu(this.source,ml()):new Nu(this.source,vl(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=Su.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{operationForChild(e){return Cl(this.path)?new Ou(this.source,ml(),this.snap.getImmediateChild(e)):new Ou(this.source,vl(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Su.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xu{operationForChild(e){if(Cl(this.path)){const t=this.children.subtree(new gl(e));return t.isEmpty()?null:t.value?new Ou(this.source,ml(),t.value):new xu(this.source,ml(),t)}return qr(_l(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new xu(this.source,vl(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Su.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lu{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Du(e,t,n,r,i,s){const o=r.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw jr("Should only compare child_ events.");const r=new Al(t.childName,t.snapshotNode),i=new Al(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,s);i.forEach((i=>{i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function Mu(e,t){return{eventCache:e,serverCache:t}}function Uu(e,t,n,r){return Mu(new Au(t,n,r),e.serverCache)}function Fu(e,t,n,r){return Mu(e.eventCache,new Au(t,n,r))}function Bu(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function qu(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ju;class Wu{static fromObject(e){let t=new Wu(null);return Hc(e,((e,n)=>{t=t.set(new gl(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:ml(),value:this.value};if(Cl(e))return null;{const n=_l(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(vl(e),t);if(null!=i){return{path:El(new gl(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Cl(e))return this;{const t=_l(e),n=this.children.get(t);return null!==n?n.subtree(vl(e)):new Wu(null)}}set(e,t){if(Cl(e))return new Wu(t,this.children);{const n=_l(e),r=(this.children.get(n)||new Wu(null)).set(vl(e),t),i=this.children.insert(n,r);return new Wu(this.value,i)}}remove(e){if(Cl(e))return this.children.isEmpty()?new Wu(null):new Wu(null,this.children);{const t=_l(e),n=this.children.get(t);if(n){const r=n.remove(vl(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new Wu(null):new Wu(this.value,i)}return this}}get(e){if(Cl(e))return this.value;{const t=_l(e),n=this.children.get(t);return n?n.get(vl(e)):null}}setTree(e,t){if(Cl(e))return t;{const n=_l(e),r=(this.children.get(n)||new Wu(null)).setTree(vl(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new Wu(this.value,i)}}fold(e){return this.fold_(ml(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(El(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,ml(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Cl(e))return null;{const r=_l(e),i=this.children.get(r);return i?i.findOnPath_(vl(e),El(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,ml(),t)}foreachOnPath_(e,t,n){if(Cl(e))return this;{this.value&&n(t,this.value);const r=_l(e),i=this.children.get(r);return i?i.foreachOnPath_(vl(e),El(t,r),n):new Wu(null)}}foreach(e){this.foreach_(ml(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(El(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(ju||(ju=new ql(Bc)),ju))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hu{static empty(){return new Hu(new Wu(null))}constructor(e){this.writeTree_=e}}function zu(e,t,n){if(Cl(t))return new Hu(new Wu(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=Tl(i,t);return s=s.updateChild(o,n),new Hu(e.writeTree_.set(i,s))}{const r=new Wu(n),i=e.writeTree_.setTree(t,r);return new Hu(i)}}}function $u(e,t,n){let r=e;return Hc(n,((e,n)=>{r=zu(r,El(t,e),n)})),r}function Vu(e,t){if(Cl(t))return Hu.empty();{const n=e.writeTree_.setTree(t,new Wu(null));return new Hu(n)}}function Ku(e,t){return null!=Gu(e,t)}function Gu(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Tl(n.path,t)):null}function Ju(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Yl,((e,n)=>{t.push(new Al(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Al(e,n.value))})),t}function Yu(e,t){if(Cl(t))return e;{const n=Gu(e,t);return new Hu(null!=n?new Wu(n):e.writeTree_.subtree(t))}}function Qu(e){return e.writeTree_.isEmpty()}function Xu(e,t){return Zu(ml(),e.writeTree_,t)}function Zu(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?(qr(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=Zu(El(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(El(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eh(e,t){return fh(t,e)}function th(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));qr(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let i=r.visible,s=!1,o=e.allWrites.length-1;for(;i&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&nh(t,r.path)?i=!1:kl(r.path,t.path)&&(s=!0)),o--}if(i){if(s)return function(e){e.visibleWrites=ih(e.allWrites,rh,ml()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=Vu(e.visibleWrites,r.path);else{Hc(r.children,(t=>{e.visibleWrites=Vu(e.visibleWrites,El(r.path,t))}))}return!0}return!1}function nh(e,t){if(e.snap)return kl(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&kl(El(e.path,n),t))return!0;return!1}function rh(e){return e.visible}function ih(e,t,n){let r=Hu.empty();for(let i=0;i<e.length;++i){const s=e[i];if(t(s)){const e=s.path;let t;if(s.snap)kl(n,e)?(t=Tl(n,e),r=zu(r,t,s.snap)):kl(e,n)&&(t=Tl(e,n),r=zu(r,ml(),s.snap.getChild(t)));else{if(!s.children)throw jr("WriteRecord should have .snap or .children");if(kl(n,e))t=Tl(n,e),r=$u(r,t,s.children);else if(kl(e,n))if(t=Tl(e,n),Cl(t))r=$u(r,ml(),s.children);else{const e=yi(s.children,_l(t));if(e){const n=e.getChild(vl(t));r=zu(r,ml(),n)}}}}}return r}function sh(e,t,n,r,i){if(r||i){const s=Yu(e.visibleWrites,t);if(!i&&Qu(s))return n;if(i||null!=n||Ku(s,ml())){const s=function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(kl(e.path,t)||kl(t,e.path))};return Xu(ih(e.allWrites,s,t),n||iu.EMPTY_NODE)}return null}{const r=Gu(e.visibleWrites,t);if(null!=r)return r;{const r=Yu(e.visibleWrites,t);if(Qu(r))return n;if(null!=n||Ku(r,ml())){return Xu(r,n||iu.EMPTY_NODE)}return null}}}function oh(e,t,n,r){return sh(e.writeTree,e.treePath,t,n,r)}function ah(e,t){return function(e,t,n){let r=iu.EMPTY_NODE;const i=Gu(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild(Yl,((e,t)=>{r=r.updateImmediateChild(e,t)})),r;if(n){const i=Yu(e.visibleWrites,t);return n.forEachChild(Yl,((e,t)=>{const n=Xu(Yu(i,new gl(e)),t);r=r.updateImmediateChild(e,n)})),Ju(i).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}return Ju(Yu(e.visibleWrites,t)).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function ch(e,t,n,r){return function(e,t,n,r,i){qr(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=El(t,n);if(Ku(e.visibleWrites,s))return null;{const t=Yu(e.visibleWrites,s);return Qu(t)?i.getChild(n):Xu(t,i.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function lh(e,t){return function(e,t){return Gu(e.visibleWrites,t)}(e.writeTree,El(e.treePath,t))}function uh(e,t,n,r,i,s){return function(e,t,n,r,i,s,o){let a;const c=Yu(e.visibleWrites,t),l=Gu(c,ml());if(null!=l)a=l;else{if(null==n)return[];a=Xu(c,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let c=n.getNext();for(;c&&e.length<i;)0!==t(c,r)&&e.push(c),c=n.getNext();return e}}(e.writeTree,e.treePath,t,n,r,i,s)}function hh(e,t,n){return function(e,t,n,r){const i=El(t,n),s=Gu(e.visibleWrites,i);if(null!=s)return s;if(r.isCompleteForChild(n))return Xu(Yu(e.visibleWrites,i),r.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function dh(e,t){return fh(El(e.treePath,t),e.writeTree)}function fh(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ph{trackChildChange(e){const t=e.type,n=e.childName;qr("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),qr(".priority"!==n,"Only non-priority child changes can be tracked.");const r=this.changeMap.get(n);if(r){const i=r.type;if("child_added"===t&&"child_removed"===i)this.changeMap.set(n,du(n,e.snapshotNode,r.snapshotNode));else if("child_removed"===t&&"child_added"===i)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===i)this.changeMap.set(n,hu(n,r.oldSnap));else if("child_changed"===t&&"child_added"===i)this.changeMap.set(n,uu(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==i)throw jr("Illegal combination of changes: "+e+" occurred after "+r);this.changeMap.set(n,du(n,e.snapshotNode,r.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gh=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class mh{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Au(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return hh(this.writes_,e,t)}}getChildAfterChild(e,t,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:qu(this.viewCache_),i=uh(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(e,t,n,r,i){const s=new ph;let o,a;if(n.type===Su.OVERWRITE){const c=n;c.source.fromUser?o=wh(e,t,c.path,c.snap,r,i,s):(qr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Cl(c.path),o=vh(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===Su.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=El(n,r);bh(t,_l(l))&&(a=wh(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=El(n,r);bh(t,_l(l))||(a=wh(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(qr(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Eh(e,t,c.path,c.children,r,i,a,s))}else if(n.type===Su.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=lh(r,n))return t;{const a=new mh(r,t,i),c=t.eventCache.getNode();let l;if(Cl(n)||".priority"===_l(n)){let n;if(t.serverCache.isFullyInitialized())n=oh(r,qu(t));else{const e=t.serverCache.getNode();qr(e instanceof iu,"serverChildren would be complete if leaf node"),n=ah(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=_l(n);let u=hh(r,i,t.serverCache);null==u&&t.serverCache.isCompleteForChild(i)&&(u=c.getImmediateChild(i)),l=null!=u?e.filter.updateChild(c,i,u,vl(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,iu.EMPTY_NODE,vl(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=oh(r,qu(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=lh(r,ml()),Uu(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,r,i,s):function(e,t,n,r,i,s,o){if(null!=lh(i,n))return t;const a=t.serverCache.isFiltered(),c=t.serverCache;if(null!=r.value){if(Cl(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return vh(e,t,n,c.getNode().getChild(n),i,s,a,o);if(Cl(n)){let r=new Wu(null);return c.getNode().forEachChild(Ul,((e,t)=>{r=r.set(new gl(e),t)})),Eh(e,t,n,r,i,s,a,o)}return t}{let l=new Wu(null);return r.foreach(((e,t)=>{const r=El(n,e);c.isCompleteForPath(r)&&(l=l.set(e,c.getNode().getChild(r)))})),Eh(e,t,n,l,i,s,a,o)}}(e,t,a.path,a.affectedTree,r,i,s)}else{if(n.type!==Su.LISTEN_COMPLETE)throw jr("Unknown operation type: "+n.type);o=function(e,t,n,r,i){const s=t.serverCache,o=Fu(t,s.getNode(),s.isFullyInitialized()||Cl(n),s.isFiltered());return yh(e,o,n,r,gh,i)}(e,t,n.path,r,s)}const c=s.getChanges();return function(e,t,n){const r=t.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=Bu(e);(n.length>0||!e.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(lu(Bu(t)))}}(t,o,c),{viewCache:o,changes:c}}function yh(e,t,n,r,i,s){const o=t.eventCache;if(null!=lh(r,n))return t;{let a,c;if(Cl(n))if(qr(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=qu(t),i=ah(r,n instanceof iu?n:iu.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),i,s)}else{const n=oh(r,qu(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,s)}else{const l=_l(n);if(".priority"===l){qr(1===yl(n),"Can't have a priority with additional path components");const i=o.getNode();c=t.serverCache.getNode();const s=ch(r,n,i,c);a=null!=s?e.filter.updatePriority(i,s):o.getNode()}else{const u=vl(n);let h;if(o.isCompleteForChild(l)){c=t.serverCache.getNode();const e=ch(r,n,o.getNode(),c);h=null!=e?o.getNode().getImmediateChild(l).updateChild(u,e):o.getNode().getImmediateChild(l)}else h=hh(r,l,t.serverCache);a=null!=h?e.filter.updateChild(o.getNode(),l,h,u,i,s):o.getNode()}}return Uu(t,a,o.isFullyInitialized()||Cl(n),e.filter.filtersNodes())}}function vh(e,t,n,r,i,s,o,a){const c=t.serverCache;let l;const u=o?e.filter:e.filter.getIndexedFilter();if(Cl(n))l=u.updateFullNode(c.getNode(),r,null);else if(u.filtersNodes()&&!c.isFiltered()){const e=c.getNode().updateChild(n,r);l=u.updateFullNode(c.getNode(),e,null)}else{const e=_l(n);if(!c.isCompleteForPath(n)&&yl(n)>1)return t;const i=vl(n),s=c.getNode().getImmediateChild(e).updateChild(i,r);l=".priority"===e?u.updatePriority(c.getNode(),s):u.updateChild(c.getNode(),e,s,i,gh,null)}const h=Fu(t,l,c.isFullyInitialized()||Cl(n),u.filtersNodes());return yh(e,h,n,i,new mh(i,h,s),a)}function wh(e,t,n,r,i,s,o){const a=t.eventCache;let c,l;const u=new mh(i,t,s);if(Cl(n))l=e.filter.updateFullNode(t.eventCache.getNode(),r,o),c=Uu(t,l,!0,e.filter.filtersNodes());else{const i=_l(n);if(".priority"===i)l=e.filter.updatePriority(t.eventCache.getNode(),r),c=Uu(t,l,a.isFullyInitialized(),a.isFiltered());else{const s=vl(n),l=a.getNode().getImmediateChild(i);let h;if(Cl(s))h=r;else{const e=u.getCompleteChild(i);h=null!=e?".priority"===wl(s)&&e.getChild(Il(s)).isEmpty()?e:e.updateChild(s,r):iu.EMPTY_NODE}if(l.equals(h))c=t;else{c=Uu(t,e.filter.updateChild(a.getNode(),i,h,s,u,o),a.isFullyInitialized(),e.filter.filtersNodes())}}}return c}function bh(e,t){return e.eventCache.isCompleteForChild(t)}function Ih(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Eh(e,t,n,r,i,s,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let c,l=t;c=Cl(n)?r:new Wu(null).setTree(n,r);const u=t.serverCache.getNode();return c.children.inorderTraversal(((n,r)=>{if(u.hasChild(n)){const c=Ih(0,t.serverCache.getNode().getImmediateChild(n),r);l=vh(e,l,new gl(n),c,i,s,o,a)}})),c.children.inorderTraversal(((n,r)=>{const c=!t.serverCache.isCompleteForChild(n)&&null===r.value;if(!u.hasChild(n)&&!c){const c=Ih(0,t.serverCache.getNode().getImmediateChild(n),r);l=vh(e,l,new gl(n),c,i,s,o,a)}})),l}class Ch{get query(){return this.query_}constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,r=new fu(n.getIndex()),i=(s=n).loadsAllData()?new fu(s.getIndex()):s.hasLimit()?new gu(s):new pu(s);var s;this.processor_=function(e){return{filter:e}}(i);const o=t.serverCache,a=t.eventCache,c=r.updateFullNode(iu.EMPTY_NODE,o.getNode(),null),l=i.updateFullNode(iu.EMPTY_NODE,a.getNode(),null),u=new Au(c,o.isFullyInitialized(),r.filtersNodes()),h=new Au(l,a.isFullyInitialized(),i.filtersNodes());this.viewCache_=Mu(h,u),this.eventGenerator_=new Lu(this.query_)}}function Th(e,t){const n=qu(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Cl(t)&&!n.getImmediateChild(_l(t)).isEmpty())?n.getChild(t):null}function Sh(e){return 0===e.eventRegistrations_.length}function kh(e,t,n){const r=[];if(n){qr(null==t,"A cancel should cancel all event registrations.");const i=e.query._path;e.eventRegistrations_.forEach((e=>{const t=e.createCancelEvent(n,i);t&&r.push(t)}))}if(t){let n=[];for(let r=0;r<e.eventRegistrations_.length;++r){const i=e.eventRegistrations_[r];if(i.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(r+1));break}}else n.push(i)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return r}function Rh(e,t,n,r){t.type===Su.MERGE&&null!==t.source.queryId&&(qr(qu(e.viewCache_),"We should always have a full cache before handling merges"),qr(Bu(e.viewCache_),"Missing event cache, even though we have a server cache"));const i=e.viewCache_,s=_h(e.processor_,i,t,n,r);var o,a;return o=e.processor_,a=s.viewCache,qr(a.eventCache.getNode().isIndexed(o.filter.getIndex()),"Event snap not indexed"),qr(a.serverCache.getNode().isIndexed(o.filter.getIndex()),"Server snap not indexed"),qr(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=s.viewCache,Ph(e,s.changes,s.viewCache.eventCache.getNode(),null)}function Ph(e,t,n,r){const i=r?[r]:e.eventRegistrations_;return function(e,t,n,r){const i=[],s=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&s.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Du(e,i,"child_removed",t,r,n),Du(e,i,"child_added",t,r,n),Du(e,i,"child_moved",s,r,n),Du(e,i,"child_changed",t,r,n),Du(e,i,"value",t,r,n),i}(e.eventGenerator_,t,n,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nh,Oh;class xh{constructor(){this.views=new Map}}function Ah(e,t,n,r){const i=t.source.queryId;if(null!==i){const s=e.views.get(i);return qr(null!=s,"SyncTree gave us an op for an invalid query."),Rh(s,t,n,r)}{let i=[];for(const s of e.views.values())i=i.concat(Rh(s,t,n,r));return i}}function Lh(e,t,n,r,i){const s=t._queryIdentifier,o=e.views.get(s);if(!o){let e=oh(n,i?r:null),s=!1;e?s=!0:r instanceof iu?(e=ah(n,r),s=!1):(e=iu.EMPTY_NODE,s=!1);const o=Mu(new Au(e,s,!1),new Au(r,i,!1));return new Ch(t,o)}return o}function Dh(e,t,n,r,i,s){const o=Lh(e,t,r,i,s);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,r=[];n.getNode().isLeafNode()||n.getNode().forEachChild(Yl,((e,t)=>{r.push(uu(e,t))}));return n.isFullyInitialized()&&r.push(lu(n.getNode())),Ph(e,r,n.getNode(),t)}(o,n)}function Mh(e,t,n,r){const i=t._queryIdentifier,s=[];let o=[];const a=jh(e);if("default"===i)for(const[t,i]of e.views.entries())o=o.concat(kh(i,n,r)),Sh(i)&&(e.views.delete(t),i.query._queryParams.loadsAllData()||s.push(i.query));else{const t=e.views.get(i);t&&(o=o.concat(kh(t,n,r)),Sh(t)&&(e.views.delete(i),t.query._queryParams.loadsAllData()||s.push(t.query)))}return a&&!jh(e)&&s.push(new(qr(Nh,"Reference.ts has not been loaded"),Nh)(t._repo,t._path)),{removed:s,events:o}}function Uh(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function Fh(e,t){let n=null;for(const r of e.views.values())n=n||Th(r,t);return n}function Bh(e,t){if(t._queryParams.loadsAllData())return Wh(e);{const n=t._queryIdentifier;return e.views.get(n)}}function qh(e,t){return null!=Bh(e,t)}function jh(e){return null!=Wh(e)}function Wh(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hh=1;class zh{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Wu(null),this.pendingWriteTree_={visibleWrites:Hu.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function $h(e,t,n,r,i){return function(e,t,n,r,i){qr(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=zu(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?Zh(e,new Ou({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Vh(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if(th(e.pendingWriteTree_,t)){let t=new Wu(null);return null!=r.snap?t=t.set(ml(),!0):Hc(r.children,(e=>{t=t.set(new gl(e),!0)})),Zh(e,new Pu(r.path,t,n))}return[]}function Kh(e,t,n){return Zh(e,new Ou({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Gh(e,t,n,r,i=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||qh(o,t))){const c=Mh(o,t,n,r);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const l=c.removed;if(a=c.events,!i){const n=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),i=e.syncPointTree_.findOnPath(s,((e,t)=>jh(t)));if(n&&!i){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&jh(t)){return[Wh(t)]}{let e=[];return t&&(e=Uh(t)),Hc(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const r=n[t],i=r.query,s=nd(e,r);e.listenProvider_.startListening(cd(i),rd(e,i),s.hashFn,s.onComplete)}}}if(!i&&l.length>0&&!r)if(n){const n=null;e.listenProvider_.stopListening(cd(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(id(t));e.listenProvider_.stopListening(cd(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const r=t[n];if(!r._queryParams.loadsAllData()){const t=id(r),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return a}function Jh(e,t,n,r){const i=sd(e,r);if(null!=i){const r=od(i),s=r.path,o=r.queryId,a=Tl(s,t);return ad(e,s,new Ou(Ru(o),a,n))}return[]}function Yh(e,t,n,r=!1){const i=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Tl(e,i);s=s||Fh(t,n),o=o||jh(t)}));let a,c=e.syncPointTree_.get(i);if(c?(o=o||jh(c),s=s||Fh(c,ml())):(c=new xh,e.syncPointTree_=e.syncPointTree_.set(i,c)),null!=s)a=!0;else{a=!1,s=iu.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=Fh(t,ml());n&&(s=s.updateImmediateChild(e,n))}))}const l=qh(c,t);if(!l&&!t._queryParams.loadsAllData()){const n=id(t);qr(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const r=Hh++;e.queryToTagMap.set(n,r),e.tagToQueryMap.set(r,n)}let u=Dh(c,t,n,eh(e.pendingWriteTree_,i),s,a);if(!l&&!o&&!r){const n=Bh(c,t);u=u.concat(function(e,t,n){const r=t._path,i=rd(e,t),s=nd(e,n),o=e.listenProvider_.startListening(cd(t),i,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(r);if(i)qr(!jh(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Cl(e)&&t&&jh(t))return[Wh(t).query];{let e=[];return t&&(e=e.concat(Uh(t).map((e=>e.query)))),Hc(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const r=t[n];e.listenProvider_.stopListening(cd(r),rd(e,r))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return u}function Qh(e,t,n){const r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,((e,n)=>{const r=Fh(n,Tl(e,t));if(r)return r}));return sh(r,t,i,n,!0)}function Xh(e,t){const n=t._path;let r=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const i=Tl(e,n);r=r||Fh(t,i)}));let i=e.syncPointTree_.get(n);i?r=r||Fh(i,ml()):(i=new xh,e.syncPointTree_=e.syncPointTree_.set(n,i));const s=null!=r,o=s?new Au(r,!0,!1):null;return function(e){return Bu(e.viewCache_)}(Lh(i,t,eh(e.pendingWriteTree_,t._path),s?o.getNode():iu.EMPTY_NODE,s))}function Zh(e,t){return ed(t,e.syncPointTree_,null,eh(e.pendingWriteTree_,ml()))}function ed(e,t,n,r){if(Cl(e.path))return td(e,t,n,r);{const i=t.get(ml());null==n&&null!=i&&(n=Fh(i,ml()));let s=[];const o=_l(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=dh(r,o);s=s.concat(ed(a,c,e,t))}return i&&(s=s.concat(Ah(i,e,r,n))),s}}function td(e,t,n,r){const i=t.get(ml());null==n&&null!=i&&(n=Fh(i,ml()));let s=[];return t.children.inorderTraversal(((t,i)=>{const o=n?n.getImmediateChild(t):null,a=dh(r,t),c=e.operationForChild(t);c&&(s=s.concat(td(c,i,o,a)))})),i&&(s=s.concat(Ah(i,e,r,n))),s}function nd(e,t){const n=t.query,r=rd(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||iu.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return r?function(e,t,n){const r=sd(e,n);if(r){const n=od(r),i=n.path,s=n.queryId,o=Tl(i,t);return ad(e,i,new Nu(Ru(s),o))}return[]}(e,n._path,r):function(e,t){return Zh(e,new Nu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const r=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const r=new Error(e+" at "+t._path.toString()+": "+n);return r.code=e.toUpperCase(),r}(t,n);return Gh(e,n,null,r)}}}}function rd(e,t){const n=id(t);return e.queryToTagMap.get(n)}function id(e){return e._path.toString()+"$"+e._queryIdentifier}function sd(e,t){return e.tagToQueryMap.get(t)}function od(e){const t=e.indexOf("$");return qr(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new gl(e.substr(0,t))}}function ad(e,t,n){const r=e.syncPointTree_.get(t);qr(r,"Missing sync point for query tag that we're tracking");return Ah(r,n,eh(e.pendingWriteTree_,t),null)}function cd(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(qr(Oh,"Reference.ts has not been loaded"),Oh)(e._repo,e._path):e}class ld{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ld(t)}node(){return this.node_}constructor(e){this.node_=e}}class ud{getImmediateChild(e){const t=El(this.path_,e);return new ud(this.syncTree_,t)}node(){return Qh(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const hd=function(e,t,n){return e&&"object"==typeof e?(qr(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?dd(e[".sv"],t,n):"object"==typeof e[".sv"]?fd(e[".sv"],t):void qr(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},dd=function(e,t,n){if("timestamp"===e)return n.timestamp;qr(!1,"Unexpected server value: "+e)},fd=function(e,t,n){e.hasOwnProperty("increment")||qr(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&qr(!1,"Unexpected increment value: "+r);const i=t.node();if(qr(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const s=i.getValue();return"number"!=typeof s?r:s+r},pd=function(e,t,n,r){return md(t,new ud(n,e),r)},gd=function(e,t,n){return md(e,new ld(t),n)};function md(e,t,n){const r=e.getPriority().val(),i=hd(r,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const r=e,s=hd(r.getValue(),t,n);return s!==r.getValue()||i!==r.getPriority().val()?new Jl(s,ou(i)):e}{const r=e;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new Jl(i))),r.forEachChild(Yl,((e,r)=>{const i=md(r,t.getImmediateChild(e),n);i!==r&&(s=s.updateImmediateChild(e,i))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _d{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function yd(e,t){let n=t instanceof gl?t:new gl(t),r=e,i=_l(n);for(;null!==i;){const e=yi(r.node.children,i)||{children:{},childCount:0};r=new _d(i,r,e),n=vl(n),i=_l(n)}return r}function vd(e){return e.node.value}function wd(e,t){e.node.value=t,Td(e)}function bd(e){return e.node.childCount>0}function Id(e,t){Hc(e.node.children,((n,r)=>{t(new _d(n,e,r))}))}function Ed(e,t,n,r){n&&!r&&t(e),Id(e,(e=>{Ed(e,t,!0,r)})),n&&r&&t(e)}function Cd(e){return new gl(null===e.parent?e.name:Cd(e.parent)+"/"+e.name)}function Td(e){null!==e.parent&&function(e,t,n){const r=function(e){return void 0===vd(e)&&!bd(e)}(n),i=_i(e.node.children,t);r&&i?(delete e.node.children[t],e.node.childCount--,Td(e)):r||i||(e.node.children[t]=n.node,e.node.childCount++,Td(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Sd=/[\[\].#$\/\u0000-\u001F\u007F]/,kd=/[\[\].#$\u0000-\u001F\u007F]/,Rd=function(e){return"string"==typeof e&&0!==e.length&&!Sd.test(e)},Pd=function(e){return"string"==typeof e&&0!==e.length&&!kd.test(e)},Nd=function(e,t,n,r){r&&void 0===t||Od(Ni(e,"value"),t,n)},Od=function(e,t,n){const r=n instanceof gl?new Rl(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Nl(r));if("function"==typeof t)throw new Error(e+"contains a function "+Nl(r)+" with contents = "+t.toString());if(Uc(t))throw new Error(e+"contains "+t.toString()+" "+Nl(r));if("string"==typeof t&&t.length>10485760/3&&xi(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+Nl(r)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,i=!1;if(Hc(t,((t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(i=!0,!Rd(t)))throw new Error(e+" contains an invalid key ("+t+") "+Nl(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,a;a=t,(o=r).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(a),o.byteLength_+=xi(a),Pl(o),Od(e,s,r),function(e){const t=e.parts_.pop();e.byteLength_-=xi(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),n&&i)throw new Error(e+' contains ".value" child '+Nl(r)+" in addition to actual children.")}},xd=function(e,t,n,r){if(!(r&&void 0===n||Pd(n)))throw new Error(Ni(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ad=function(e,t){if(".info"===_l(t))throw new Error(e+" failed = Can't modify data under /.info/")},Ld=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Rd(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Pd(e)}(n))throw new Error(Ni(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Dd{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Md(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||Sl(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function Ud(e,t,n){Md(e,n),Fd(e,(e=>kl(e,t)||kl(t,e)))}function Fd(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(Bd(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Bd(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();Pc&&xc("event: "+n.toString()),Kc(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qd{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Dd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=bu(),this.transactionQueueTree_=new _d,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function jd(e,t,n){if(e.stats_=il(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new vu(e.repoInfo_,((t,n,r,i)=>{zd(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>$d(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{fi(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new xl(e.repoInfo_,t,((t,n,r,i)=>{zd(e,t,n,r,i)}),(t=>{$d(e,t)}),(t=>{!function(e,t){Hc(t,((t,n)=>{Vd(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return rl[n]||(rl[n]=t()),rl[n]}(e.repoInfo_,(()=>new Tu(e.stats_,e.server_))),e.infoData_=new wu,e.infoSyncTree_=new zh({startListening:(t,n,r,i)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=Kh(e.infoSyncTree_,t._path,o),setTimeout((()=>{i("ok")}),0)),s},stopListening:()=>{}}),Vd(e,"connected",!1),e.serverSyncTree_=new zh({startListening:(t,n,r,i)=>(e.server_.listen(t,r,n,((n,r)=>{const s=i(n,r);Ud(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Wd(e){const t=e.infoData_.getNode(new gl(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Hd(e){return(t=(t={timestamp:Wd(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function zd(e,t,n,r,i){e.dataUpdateCount++;const s=new gl(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(i)if(r){const t=wi(n,(e=>ou(e)));o=function(e,t,n,r){const i=sd(e,r);if(i){const r=od(i),s=r.path,o=r.queryId,a=Tl(s,t),c=Wu.fromObject(n);return ad(e,s,new xu(Ru(o),a,c))}return[]}(e.serverSyncTree_,s,t,i)}else{const t=ou(n);o=Jh(e.serverSyncTree_,s,t,i)}else if(r){const t=wi(n,(e=>ou(e)));o=function(e,t,n){const r=Wu.fromObject(n);return Zh(e,new xu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,s,t)}else{const t=ou(n);o=Kh(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=ef(e,s)),Ud(e.eventQueue_,a,o)}function $d(e,t){Vd(e,"connected",t),!1===t&&function(e){Yd(e,"onDisconnectEvents");const t=Hd(e),n=bu();Eu(e.onDisconnect_,ml(),((r,i)=>{const s=pd(r,i,e.serverSyncTree_,t);Iu(n,r,s)}));let r=[];Eu(n,ml(),((t,n)=>{r=r.concat(Kh(e.serverSyncTree_,t,n));const i=of(e,t);ef(e,i)})),e.onDisconnect_=bu(),Ud(e.eventQueue_,ml(),r)}(e)}function Vd(e,t,n){const r=new gl("/.info/"+t),i=ou(n);e.infoData_.updateSnapshot(r,i);const s=Kh(e.infoSyncTree_,r,i);Ud(e.eventQueue_,r,s)}function Kd(e){return e.nextWriteId_++}function Gd(e,t,n,r,i){Yd(e,"set",{path:t.toString(),value:n,priority:r});const s=Hd(e),o=ou(n,r),a=Qh(e.serverSyncTree_,t),c=gd(o,a,s),l=Kd(e),u=$h(e.serverSyncTree_,t,c,l,!0);Md(e.eventQueue_,u),e.server_.put(t.toString(),o.val(!0),((n,r)=>{const s="ok"===n;s||Mc("set at "+t+" failed: "+n);const o=Vh(e.serverSyncTree_,l,!s);Ud(e.eventQueue_,t,o),Qd(e,i,n,r)}));const h=of(e,t);ef(e,h),Ud(e.eventQueue_,h,[])}function Jd(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Yd(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),xc(n,...t)}function Qd(e,t,n,r){t&&Kc((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let i=e;r&&(i+=": "+r);const s=new Error(i);s.code=e,t(s)}}))}function Xd(e,t,n){return Qh(e.serverSyncTree_,t,n)||iu.EMPTY_NODE}function Zd(e,t=e.transactionQueueTree_){if(t||sf(e,t),vd(t)){const n=nf(e,t);qr(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const r=n.map((e=>e.currentWriteId)),i=Xd(e,t,r);let s=i;const o=i.hash();for(let e=0;e<n.length;e++){const r=n[e];qr(0===r.status,"tryToSendTransactionQueue_: items in queue should all be run."),r.status=1,r.retryCount++;const i=Tl(t,r.path);s=s.updateChild(i,r.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(r=>{Yd(e,"transaction put response",{path:c.toString(),status:r});let i=[];if("ok"===r){const r=[];for(let t=0;t<n.length;t++)n[t].status=2,i=i.concat(Vh(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&r.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();sf(e,yd(e.transactionQueueTree_,t)),Zd(e,e.transactionQueueTree_),Ud(e.eventQueue_,t,i);for(let e=0;e<r.length;e++)Kc(r[e])}else{if("datastale"===r)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Mc("transaction at "+c.toString()+" failed: "+r);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=r}ef(e,t)}}),o)}(e,Cd(t),n)}else bd(t)&&Id(t,(t=>{Zd(e,t)}))}function ef(e,t){const n=tf(e,t),r=Cd(n);return function(e,t,n){if(0===t.length)return;const r=[];let i=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=Tl(n,c.path);let u,h=!1;if(qr(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)h=!0,u=c.abortReason,i=i.concat(Vh(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)h=!0,u="maxretry",i=i.concat(Vh(e.serverSyncTree_,c.currentWriteId,!0));else{const n=Xd(e,c.path,s);c.currentInputSnapshot=n;const r=t[a].update(n.val());if(void 0!==r){Od("transaction failed: Data returned ",r,c.path);let t=ou(r);"object"==typeof r&&null!=r&&_i(r,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=Hd(e),l=gd(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=Kd(e),s.splice(s.indexOf(o),1),i=i.concat($h(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),i=i.concat(Vh(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",i=i.concat(Vh(e.serverSyncTree_,c.currentWriteId,!0))}Ud(e.eventQueue_,n,i),i=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?r.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):r.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;sf(e,e.transactionQueueTree_);for(let e=0;e<r.length;e++)Kc(r[e]);Zd(e,e.transactionQueueTree_)}(e,nf(e,n),r),r}function tf(e,t){let n,r=e.transactionQueueTree_;for(n=_l(t);null!==n&&void 0===vd(r);)r=yd(r,n),n=_l(t=vl(t));return r}function nf(e,t){const n=[];return rf(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function rf(e,t,n){const r=vd(t);if(r)for(let e=0;e<r.length;e++)n.push(r[e]);Id(t,(t=>{rf(e,t,n)}))}function sf(e,t){const n=vd(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,wd(t,n.length>0?n:void 0)}Id(t,(t=>{sf(e,t)}))}function of(e,t){const n=Cd(tf(e,t)),r=yd(e.transactionQueueTree_,t);return function(e,t,n){let r=n?e:e.parent;for(;null!==r;){if(t(r))return!0;r=r.parent}}(r,(t=>{af(e,t)})),af(e,r),Ed(r,(t=>{af(e,t)})),n}function af(e,t){const n=vd(t);if(n){const r=[];let i=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(qr(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(qr(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),i=i.concat(Vh(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&r.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?wd(t,void 0):n.length=s+1,Ud(e.eventQueue_,Cd(t),i);for(let e=0;e<r.length;e++)Kc(r[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cf=function(e,t){const n=lf(e),r=n.namespace;"firebase.com"===n.domain&&Dc(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),r&&"undefined"!==r||"localhost"===n.domain||Dc("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||"undefined"!=typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&Mc("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");const i="ws"===n.scheme||"wss"===n.scheme;return{repoInfo:new Zc(n.host,n.secure,r,i,t,"",r!==n.subdomain),path:new gl(n.pathString)}},lf=function(e){let t="",n="",r="",i="",s="",o=!0,a="https",c=443;if("string"==typeof e){let l=e.indexOf("//");l>=0&&(a=e.substring(0,l-1),e=e.substring(l+2));let u=e.indexOf("/");-1===u&&(u=e.length);let h=e.indexOf("?");-1===h&&(h=e.length),t=e.substring(0,Math.min(u,h)),u<h&&(i=function(e){let t="";const n=e.split("/");for(let e=0;e<n.length;e++)if(n[e].length>0){let r=n[e];try{r=decodeURIComponent(r.replace(/\+/g," "))}catch(e){}t+="/"+r}return t}(e.substring(u,h)));const d=function(e){const t={};"?"===e.charAt(0)&&(e=e.substring(1));for(const n of e.split("&")){if(0===n.length)continue;const r=n.split("=");2===r.length?t[decodeURIComponent(r[0])]=decodeURIComponent(r[1]):Mc(`Invalid query segment '${n}' in query '${e}'`)}return t}(e.substring(Math.min(e.length,h)));l=t.indexOf(":"),l>=0?(o="https"===a||"wss"===a,c=parseInt(t.substring(l+1),10)):l=t.length;const f=t.slice(0,l);if("localhost"===f.toLowerCase())n="localhost";else if(f.split(".").length<=2)n=f;else{const e=t.indexOf(".");r=t.substring(0,e).toLowerCase(),n=t.substring(e+1),s=r}"ns"in d&&(s=d.ns)}return{host:t,port:c,domain:n,subdomain:r,secure:o,scheme:a,pathString:i,namespace:s}};!function(){let e=0;const t=[]}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class df{onValue(e,t){this.snapshotCallback.call(null,e,t)}onCancel(e){return qr(this.hasCancelCallback,"Raising a cancel event on a listener with no cancel callback"),this.cancelCallback.call(null,e)}get hasCancelCallback(){return!!this.cancelCallback}matches(e){return this.snapshotCallback===e.snapshotCallback||void 0!==this.snapshotCallback.userCallback&&this.snapshotCallback.userCallback===e.snapshotCallback.userCallback&&this.snapshotCallback.context===e.snapshotCallback.context}constructor(e,t){this.snapshotCallback=e,this.cancelCallback=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class ff{get key(){return Cl(this._path)?null:wl(this._path)}get ref(){return new pf(this._repo,this._path)}get _queryIdentifier(){const e=yu(this._queryParams),t=jc(e);return"{}"===t?"default":t}get _queryObject(){return yu(this._queryParams)}isEqual(e){if(!((e=Ai(e))instanceof ff))return!1;const t=this._repo===e._repo,n=Sl(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class pf extends ff{get parent(){const e=Il(this._path);return null===e?null:new pf(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new mu,!1)}}class gf{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new gl(e),n=_f(this.ref,e);return new gf(this._node.getChild(t),n,Yl)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new gf(n,_f(this.ref,t),Yl))))}hasChild(e){const t=new gl(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function mf(e,t){return(e=Ai(e))._checkNotDeleted("ref"),void 0!==t?_f(e._root,t):e._root}function _f(e,t){var n,r,i,s;return null===_l((e=Ai(e))._path)?(n="child",r="path",s=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),xd(n,r,i,s)):xd("child","path",t,!1),new pf(e._repo,El(e._path,t))}function yf(e,t){e=Ai(e),Ad("set",e._path),Nd("set",t,e._path,!1);const n=new ai;return Gd(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function vf(e){e=Ai(e);const t=new df((()=>{})),n=new wf(t);return function(e,t,n){const r=Xh(e.serverSyncTree_,t);return null!=r?Promise.resolve(r):e.server_.get(t).then((r=>{const i=ou(r).withIndex(t._queryParams.getIndex());let s;if(Yh(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=Kh(e.serverSyncTree_,t._path,i);else{const n=rd(e.serverSyncTree_,t);s=Jh(e.serverSyncTree_,t._path,i,n)}return Ud(e.eventQueue_,t._path,s),Gh(e.serverSyncTree_,t,n,null,!0),i}),(n=>(Yd(e,"get for query "+fi(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new gf(t,new pf(e._repo,e._path),e._queryParams.getIndex())))}class wf{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new uf("value",this,new gf(e.snapshotNode,new pf(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new hf(this,e,t):null}matches(e){return e instanceof wf&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}!function(e){qr(!Nh,"__referenceConstructor has already been defined"),Nh=e}(pf),function(e){qr(!Oh,"__referenceConstructor has already been defined"),Oh=e}(pf);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const bf={};let If=!1;function Ef(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||Dc("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),xc("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=cf(s,i),l=c.repoInfo;void 0!==Ir&&Ir.env&&(a=Ir.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=cf(s,i),l=c.repoInfo):o=!c.repoInfo.secure;const u=i&&o?new Qc(Qc.OWNER):new Yc(e.name,e.options,t);Ld("Invalid Firebase Database URL",c),Cl(c.path)||Dc("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,r){let i=bf[t.name];i||(i={},bf[t.name]=i);let s=i[e.toURLString()];s&&Dc("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new qd(e,If,n,r),i[e.toURLString()]=s,s}(l,e,u,new Jc(e.name,n));return new Cf(h,e)}class Cf{get _repo(){return this._instanceStarted||(jd(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new pf(this._repo,ml())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=bf[t];n&&n[e.key]===e||Dc(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Jd(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Dc("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}xl.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},xl.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){vc="9.15.0",ps(new Li("database",((e,{instanceIdentifier:t})=>Ef(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ws("@firebase/database","0.14.0",e),ws("@firebase/database","0.14.0","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const Tf=ys({apiKey:"AIzaSyCDhc_FFOW788b9xS67xRCHGL2Falcnxko",authDomain:"filmoteks-fs61.firebaseapp.com",projectId:"filmoteks-fs61",storageBucket:"filmoteks-fs61.appspot.com",messagingSenderId:"392503967659",appId:"1:392503967659:web:7720f7b1803ed8583b9cee",measurementId:"G-JLEERBJV8V",databaseURL:"https://filmoteks-fs61-default-rtdb.europe-west1.firebasedatabase.app"}),Sf=function(e=vs()){const t=gs(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=gs(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(bi(n.getOptions(),null!=t?t:{}))return e;Ms(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:pc,persistence:[Na,ma,ya]}),r=oi("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>mc)return;const r=null==t?void 0:t.token;_c!==r&&(_c=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){Ai(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){Ai(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=ii("auth");return s&&Fo(n,`http://${s}`),n}(Tf),kf=function(e=vs(),t){const n=gs(e,"database").getImmediate({identifier:t}),r=si("database");return r&&function(e,t,n,r={}){(e=Ai(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&Dc("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&Dc('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new Qc(Qc.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:ci(r.mockUserToken,e.app.options.projectId);s=new Qc(t)}!function(e,t,n,r){e.repoInfo_=new Zc(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),r&&(e.authTokenProvider_=r)}(i,t,n,s)}(n,...r),n}(Tf),Rf=[{code:"auth/user-not-found",massage_ru:"Пользователь с такой почтой и паролем не найден",message_ua:"Користувача за цією поштою або паролем не знайдено ",message_en:"User with this password or email don'n found "},{code:"auth/network-request-failed",massage_ru:"Ошибка подключения . Проверьте наличие интернета.",message_ua:"Помилка підключення. Перевірте наявність інтернета",message_en:"Network error!"},{code:"auth/email-already-in-use",massage_ru:"Пользователь с такой почтой уже зарегистрирован!",message_ua:"Користувач з такую поштою вже в системі!",message_en:"This email already in use!"},{code:"auth/login",massage_ru:"Не авторизированные пользователи не могут пользоваться библиотекой",message_ua:"Не автризовані користувачи не можуть користуватися бібліотекою!",message_en:"Not auth users can't use library. Please  login!"},{code:"noData/available",message_ua:"Зараз тут пусто",message_ru:"Здесь сейчас пусто",message_en:"Now there is no films here"},{code:"films/place",message_ru:"Не правильно указан источник",message_ua:"Не правильно вказана папка ",message_en:"Invalid  folder"}],Pf={code:"default",message_ru:"Что-то пошло не так!",message_ua:"Упс Щось пішло не так!",message_en:"Oops. Something went wrong!"};function Nf(e,t="en"){const n=Rf.find((({code:t})=>t===e));return n?n["message_"+t]:Pf["message_"+t]}function Of(e,t){console.log("RenderLoginMainPage =",e,"user=",t)}const xf=new class{getUserDisplayName(){return this.isLogin?this.user.displayName&&this.user.displayName.length>0?this.user.displayName:this.user.email:""}getUserUid(){return this.isLogin?this.user?.uid:null}async login(e,t){try{const n=await da(Sf,e,t);return this.user=n.user,""}catch(e){return Nf(e.code,this.language)}}async singUp(e,t,n=""){try{const r=await ha(Sf,e,t);return this.user=r.user,n.length,await fa(this.user,{displayName:n}),""}catch(e){return Nf(e.code,this.language)}}async logOut(){if(!this.isLogin)return"";try{return await Sf.signOut(),""}catch(e){return Nf(e.code,this.language)}}constructor(e,t="en"){console.log("constructor"),this.user=e,this.isLogin=!!e,this.language=t}}(null);Sf.onAuthStateChanged((e=>{e?(xf.user=e,xf.isLogin=!0):(xf.user=null,xf.isLogin=!1),Of(xf.isLogin,xf.getUserDisplayName())}));const Af=Qn();Af.modeButton.addEventListener("click",(function(){document.body.classList.contains("moon")?(document.body.classList.remove("moon"),Af.moon.classList.add("visually-hidden"),Af.sun.classList.remove("visually-hidden"),localStorage.setItem("mode",!1)):(document.body.classList.add("moon"),localStorage.setItem("mode","moon"),Af.sun.classList.add("visually-hidden"),Af.moon.classList.remove("visually-hidden"))})),"moon"===localStorage.getItem("mode")&&(document.body.classList.add("moon"),Af.sun.classList.add("visually-hidden"),Af.moon.classList.remove("visually-hidden"));var Lf=new WeakSet;async function Df(){if(this.setUid(),!this.refs)return!1;if(0===this.filmList.length){const e=await vf(_f(this.refs,"/"));if(e.exists()){const t=e.val();this.filmList=Object.values(t).map((({id:e,title:t,genres:n,year:r,poster_path:i,vote:s,place:o})=>{const a=new Jn({id:e,title:t,genres:n,year:r,poster_path:i,vote:s});return a.place=o,a}))}return this.isReadFilm=!0,!0}}const Mf=new class{setUid(){this.uid=xf.getUserUid(),this.uid?this.refs=mf(this.db,"users/"+this.uid):(this.uid=null,this.refs=null,this.filmList=[]),this.isReadFilm=!1}async checkFilmInList(t,n){this.isReadFilm||await e(m)(this,Lf,Df).call(this);for(let e=0;e<this.filmList.length;e+=1)if(this.filmList[e].id===t)return this.filmList[e].place=n,this.filmList[e];return null}async writeTo(e,t){if("QU"!=t&&"WA"!=t)return Nf("films/place",this.language);if(!this.uid)return Nf("auth/login",this.language);try{let n=await this.checkFilmInList(e.id,t);if(console.log("filmW:",n),!n){const{id:r,title:i,genres:s,release_date:o,poster_path:a,vote:c,language:l}=e;n=new Jn({id:r,title:i,genres:s,year:o,poster_path:a,vote:c,language:l}),n.place=t,this.filmList.push(n),console.log("writeTo this.filmList=",this.filmList)}return await yf(mf(this.db,"users/"+this.uid+"/"+n.id),n),""}catch(e){return Nf(e.code,this.language)}}async getFilms(t){if(this.setUid(),"QU"!=t&&"WA"!=t)return Nf("films/place",this.language);if(!this.refs)return Nf("auth/login",this.language);try{this.isReadFilm||await e(m)(this,Lf,Df).call(this)}catch(e){return Nf(e.code,this.language)}return{films:this.filmList.filter((e=>e.place===t)),message:""}}constructor(t="en"){e(_)(this,Lf),this.db=kf,this.language=t,this.refs=null,this.filmList=[],this.uid=null,this.isReadFilm=!1}};document.querySelector(".footer").addEventListener("click",(()=>{!async function(){const e=await xf.logOut();console.log(e)}()})),document.querySelector(".header").addEventListener("click",(()=>{console.log("login"),async function(){const e=await xf.login("some9email@mail.com","anypassword");console.log(e),console.log(xf.getUserDisplayName())}(),async function(){if(xf.isLogin){const e=await Mf.getFilms("QU");console.log("filmsQU",e);const t=await Mf.getFilms("WA");console.log("films WA= ",t)}}()})),console.log("change12");
//# sourceMappingURL=index.58df2907.js.map
